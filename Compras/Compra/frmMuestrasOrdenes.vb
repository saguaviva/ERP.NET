...
Public Class frmMuestrasOrdenes
...
#End Region
    ...
    Shared frmChildForm As frmMuestrasOrdenes
    Public Shared Function GetInstance() As frmMuestrasOrdenes
        If frmChildForm Is Nothing Then
            frmChildForm = New frmMuestrasOrdenes
        End If
        Return frmChildForm
    End Function
    ...
    Private Sub IniciarForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            cargando = True
            tabla = tablaCompras
            IniciarDocumento(Muestra, OrdenFabComplementos)
