        ...
        Try
            ...
            With dv.Item(0)
                ...
                cmdInsertar.CommandText = "INSERT INTO " & tablaVentas & " (" & _
                        ...
                        " ""A"", " & _
                        " ""P"", " & _
                        " """ & general.NS(UltimoPAF, True) & """, " & _
                        " """ & general.NS(orden.CLIENT, True) & """, " & _
                        " """ & fecha2 & """, " & _
                        " ""0"", " & _
                        " """", " & _
                        " """ & general.NS(orden.REPRES, True) & """, " & _
                        " """ & general.NS(orden.COMIS, True) & """, " & _
                        " """ & general.NS(orden.centro) & """, " & _
                        " """ & general.NS(orden.ORDRE, True) & """, " & _
                        " """ & general.NS(orden.PREU, True) & """, " & _
                        " """ & general.NS(orden.ALBARA) & """, " & _
                        " """ & general.NS(orden.TALLA01) & """," & _
                        " """ & general.NS(orden.TALLA02) & """," & _
                        " """ & general.NS(orden.TALLA03) & """," & _
                        " """ & general.NS(orden.TALLA04) & """," & _
                        " """ & general.NS(orden.TALLA05) & """," & _
                        " """ & general.NS(orden.TALLA06) & """," & _
                        " """ & general.NS(orden.TALLA07) & """," & _
                        " """ & general.NS(orden.TALLA08) & """," & _
                        " """ & general.NS(orden.TALLA09) & """," & _
                        " """ & general.NS(orden.TALLA10) & """," & _
                        " """ & general.NS(orden.MODEL) & """," & _
                        " """ & general.NS(orden.SERIE) & """," & _
                        " """ & orden.EXPEDICIO & """," & _
                        " """ & general.NS(orden.TEMPORADA) & """ )"
    ...
    Friend Function TraspasarNLineas2(ByVal aAF As Integer, ByVal linea As clsDetallePAFCompraModelo) ' ByVal tejido As String, ByVal cantidad As Integer, ByVal color As String, ByVal documento as string, ByVal tipo as string, ByVal dvLineas As DataView, ByVal dePA As Integer, ByVal nlinea As Integer, ByVal CENTRO As Char)
        ...
        Try
            ...
            cmdInsertar.CommandText = "INSERT INTO " & tablaLineasVenta & "(" & _
                    ...
                    " " & aAF & ", " & _
                    " " & nlineas & ", " & _
                    " """ & general.NS(Orden.detallePAF.COLOR) & """, " & _
                    " """ & general.NS(Orden.ORDRE, True) & """, " & _
                    " """ & general.NS(Orden.centro) & """, " & _
                    " """ & general.NS(Orden.TEMPORADA) & """, " & _
                    " """ & general.NS(Orden.detallePAF.TARA1, True) & """, " & _
                    " """ & general.NS(Orden.detallePAF.TARA2, True) & """, " & _
                    " """ & general.NS(Orden.detallePAF.TARA3, True) & """, " & _
                    " """ & general.NS(Orden.detallePAF.TARA4, True) & """, " & _
                    " """ & general.NS(Orden.detallePAF.TARA5, True) & """, " & _
                    " """ & general.NS(Orden.detallePAF.TARA6, True) & """, " & _
                    " """ & general.NS(Orden.detallePAF.TARA7, True) & """, " & _
                    " """ & general.NS(Orden.detallePAF.TARA8, True) & """, " & _
                    " """ & general.NS(Orden.detallePAF.TARA9, True) & """, " & _
                    " """ & general.NS(Orden.detallePAF.TARA10, True) & """," & _
                    " """ & general.NS(Orden.TALLA01) & """," & _
                    " """ & general.NS(Orden.TALLA02) & """," & _
                    " """ & general.NS(Orden.TALLA03) & """," & _
                    " """ & general.NS(Orden.TALLA04) & """," & _
                    ...
                    " """ & general.NS(Orden.TALLA09) & """," & _
                    " """ & general.NS(Orden.TALLA10) & """," & _
                    " """ & general.NS(TALLA01, True) & """," & _
                    " """ & general.NS(TALLA02, True) & """," & _
                    " """ & general.NS(TALLA03, True) & """," & _
                    " """ & general.NS(TALLA04, True) & """," & _
                    " """ & general.NS(TALLA05, True) & """," & _
                    " """ & general.NS(TALLA06, True) & """," & _
                    " """ & general.NS(TALLA07, True) & """," & _
                    " """ & general.NS(TALLA08, True) & """," & _
                    " """ & general.NS(TALLA09, True) & """," & _
                    " """ & general.NS(TALLA10, True) & """," & _
                    " """ & general.NS(TALLA01 + TALLA02 + TALLA03 + TALLA04 + TALLA05 + TALLA06 + TALLA07 + TALLA08 + TALLA09 + TALLA10, True) & """, ""0"")"
...
#End Region
    ...
    Private Function ActualizarStockTejidos(ByVal cantidad As Double) As Boolean
        ...
        Try
            ...
            '        strSQL = "UPDATE " & tablaHiloColores & " SET ACTUAL = ACTUAL + " & cantidad & " WHERE(FIL = """ & general.NS(PAF.lineasVenta.MOSTRA) & """ AND TIPUS = ""T"" AND COLOR = """ & general.NS(PAF.lineasVenta.COLOR) & """)"
            '        cmdUpd.CommandText = strSQL
            '        cmdUpd.ExecuteNonQuery()
            '        CCN()
            '        Return True
            '    Else
            '        strSQL = "SELECT ACTUAL FROM " & tablaHiloColores & " WHERE(FIL = """ & general.NS(PAF.lineasVenta.MOSTRA) & """ AND TIPUS = ""T"" AND COLOR = """ & general.NS(PAF.lineasVenta.COLOR) & """)"
