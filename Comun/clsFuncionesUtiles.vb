...
Public Class clsFuncionesUtiles
    Public Shared cnn As MySql.Data.MySqlClient.MySqlConnection

    'Friend monitor As MySql.Data.MySqlClient.MySqlMonitor
...
#Region "PARAMETROS"
    ...
    Shared Sub añadirParametroIdentificador(ByRef cmd As MySqlCommand, ByVal tipo As String, ByVal campo As String)

        Select Case tipo
            Case "double" : cmd.Parameters.Add(New MySqlParameter("pi" & campo, MySqlDbType.Double, 0, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), campo, System.Data.DataRowVersion.Original, Nothing))
            Case "varchar" : cmd.Parameters.Add(New MySqlParameter("pi" & campo, MySqlDbType.VarChar, 0, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), campo, System.Data.DataRowVersion.Original, Nothing))
            Case "int" : cmd.Parameters.Add(New MySqlParameter("pi" & campo, MySqlDbType.Int32, 0, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), campo, System.Data.DataRowVersion.Original, Nothing))
            Case "integer" : cmd.Parameters.Add(New MySqlParameter("pi" & campo, MySqlDbType.Int32, 0, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), campo, System.Data.DataRowVersion.Original, Nothing))
            Case "tinyint" : cmd.Parameters.Add(New MySqlParameter("pi" & campo, MySqlDbType.Int16, 0, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), campo, System.Data.DataRowVersion.Original, Nothing))
            Case "date" : cmd.Parameters.Add(New MySqlParameter("pi" & campo, MySqlDbType.Date, 0, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), campo, System.Data.DataRowVersion.Original, Nothing))
            Case "text" : cmd.Parameters.Add(New MySqlParameter("pi" & campo, MySqlDbType.Text, 0, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), campo, System.Data.DataRowVersion.Original, Nothing))
            Case "tinyintunsigned" : cmd.Parameters.Add(New MySqlParameter("pi" & campo, MySqlDbType.Int16, 1, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), campo, System.Data.DataRowVersion.Original, Nothing))
            Case "blob" : cmd.Parameters.Add(New MySqlParameter("pi" & campo, MySqlDbType.Blob, 0, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), campo, System.Data.DataRowVersion.Original, Nothing))
        End Select

    End Sub
    Shared Sub añadirParametro(ByRef cmd As IDbCommand, ByVal tipo As String, ByVal campo As String, Optional ByVal BD As String = "MYSQL")
    ...
    End Sub
    'Shared Sub añadirParametro(ByRef cmd As oled, ByVal tipo As String, ByVal campo As String)
...
#Region "ORGANIZAR"
    ...
    Public Shared Sub ActualizarNum(ByVal tabla As String, ByVal documento As String, ByVal centr As String, ByVal codi As Double, Optional ByVal tipo As String = "M")
        ...
        End Try
    End Sub
    Public Shared Function TipoNET2SQL(ByVal tipo As System.Type) As String
        Try
        ...
        End Try
    End Function
    Public Shared Function esPrimaryKey(ByVal cons As System.Data.UniqueConstraint, ByVal columna As String) As Boolean
        ...
        End Try
    End Function
    Public Function NS(ByVal str As Object, Optional ByVal esNumero As Boolean = False) As String
        Try
        ...
        End Try
    End Function
    Shared Sub AñadirBinding(ByVal c As Object, ByVal dv As DataView, ByVal campo As String, Optional ByVal elementoBinding As String = "Text")
        Try
        ...
        End Try
    End Sub
    Shared Sub AñadirBindingCombo(ByVal c As C1.Win.C1List.C1Combo, ByVal dv As DataView, ByVal valuemember As String, ByVal DisplayMember As String)
        Dim i As Integer
        Try
            With c
                .DataSource = dv
        ...
        End Try
    End Sub
    Shared Sub AñadirBindingCombo(ByVal c As C1.Win.C1List.C1Combo, ByVal dt As DataTable, ByVal valuemember As String, ByVal DisplayMember As String)
        Dim i As Integer
        ...
        End Try
    End Sub
    Shared Sub AñadirBindingCombo(ByVal c As C1.Win.C1TrueDBGrid.C1TrueDBDropdown, ByVal dt As DataTable, ByVal ListField As String, ByVal DataField As String)
        Dim i As Integer
        Try
            With c
                .DataSource = dt
        ...
        End Try
    End Sub
    Shared Sub AñadirBindingCombo(ByVal c As C1.Win.C1TrueDBGrid.C1TrueDBDropdown, ByVal dv As DataView, ByVal ListField As String, ByVal DataField As String)
        Dim i As Integer
        Try
            With c
                .DataSource = dv
    ...
    Public Function ponercontrabarrasreal(ByRef valorcampo As String) As Object
        Try
            If valorcampo Is Nothing Then
                Return Nothing
            End If
            valorcampo = CType(nz(valorcampo.Replace("""", "\"""), ""), String)
            Return valorcampo
        Catch ex As Exception
            clsFuncionesLOG.LOG(ex.ToString) : CCN() : Return Nothing
        End Try
    End Function
    Shared Function nzn(ByVal str As Object, ByVal defecto As Object) As Double
        Try
        ...
        End Try
    End Function
    Public Function nz(ByVal str As Object, ByVal defecto As Object, Optional ByVal numerico As Boolean = False, Optional ByVal esFecha As Boolean = False) As Object
        Try
        ...
        End Try
    End Function
    Public Function OBN(ByVal codi As Object, ByVal dt As DataTable, Optional ByVal nombre As String = "NOM", _
        ...
        End Try
    End Function
    Public Shared Function DLookUp(ByVal sChamp$, ByVal sTable$, ByVal sCritere$, _
    ...
    End Function
    Public Shared Function roundnum(ByVal num As Double, ByVal place As Integer) As Double
    ...
    End Function
    Public Shared Function esCampoDeNombre(ByVal campo As String) As Boolean
        Try
            Select Case campo
        ...
        End Try
    End Function
    Public Shared Function ConvertirAfechaMysql(ByVal fecha As Date) As String
        Try
        ...
        End Try
    End Function
    Public Shared Function GetCampo(ByVal tabla As String, ByVal campo As String, ByVal id1 As Object, _
        ...
        End Try
    End Function
    Public Shared Function sumaTotal(ByVal campo As String, ByVal dv As DataView) As Double
        Dim i As Integer
        Dim suma As Double
        Try
...
#Region "CARGAR"
    ...
    Shared Sub CargarTablas(ByVal aTablaOriginal As ArrayList, ByVal aCampoCODIGO As ArrayList, ByVal aCampoNOMBRE As ArrayList, ByRef aDT As ArrayList, ByVal nocerrarconexion As Boolean)
        Dim cmdSel As New MySqlCommand
        ...
        End Try
    End Sub
    Shared Sub PonerCaptions(ByVal dt As DataTable)
        Dim i As Integer
        Try
            For i = 0 To dt.Columns.Count - 1
                With dt.Columns(i)
    ...
    Shared Sub CargaTabla(ByVal tablaOriginal As String, ByVal campos As ArrayList, ByRef dt As DataTable, ByVal nocerrar As Boolean)
        ...
        End Try
    End Sub
    Shared Sub CargaTabla(ByVal tablaOriginal As String, ByVal campos As ArrayList, ByRef dt As DataTable, ByVal nocerrar As Boolean, ByVal sqlWhere As String)
        Dim cmdSelect As New MySqlCommand
        Dim daSelect As New MySqlDataAdapter
        Try
            cmdSelect.Connection = cnn
        ...
        End Try
    End Sub
    Shared Sub CargaTabla(ByVal tablaOriginal As String, ByVal campoCODIGO As String, ByVal campoNOMBRE As String, ByRef dt As DataTable, Optional ByVal nocerrar As Boolean = False, Optional ByVal centr As String = "C")
        Dim cmdSelect As New MySqlCommand
        Dim daSelect As New MySqlDataAdapter
        Try
            cmdSelect.Connection = cnn
    ...
    Shared Sub CargaTabla(ByVal tablaOriginal As String, ByRef dt As DataTable, ByVal sql As String, Optional ByVal nocerrar As Boolean = False)
        Dim cmdSelect As New MySqlCommand
        Dim daSelect As New MySqlDataAdapter
        Try
            cmdSelect.Connection = cnn
...
#End Region
    ...
    Shared Sub CopiarFila(ByRef filaOrigen As DataRow, ByRef filaDestino As DataRow)
        Dim i As Integer
        Try
    ...
    Shared Sub GrabaParametro(ByVal codigo As Object, ByVal nombreparametro As String)
        Try
            ...
            directorio = CurDir() & "\"
            xmlDoc.Load(CurDir() & "\conf\ultimos.xml")
            ...
            Dim wrtr As Xml.XmlTextWriter = New Xml.XmlTextWriter(CurDir() & "\conf\ultimos.xml", System.Text.Encoding.Unicode)
            xmlDoc.WriteTo(wrtr)
            wrtr.Close()
        ...
        End Try
    End Sub
    Public Shared Function CargaParametro(ByVal nombreparametro As String) As Object
        ...
        End Try
    End Function
    Public Shared Function ObtenerLocalizacion(ByVal c As Control) As Point
        Try
            Dim p As Point
    ...
    Public Shared Sub CargarImagen(ByVal obj As Object, ByRef control As PictureBox)
        Try
