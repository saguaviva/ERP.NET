...
public sealed class SaveTejidoCommand
{
    ...
    public List<SaveTejidoColorInput> Colors { get; set; } = [];
    public List<SaveTejidoCompositionInput> Composition { get; set; } = [];
    public List<SaveTejidoFinishInput> Finishes { get; set; } = [];
}
