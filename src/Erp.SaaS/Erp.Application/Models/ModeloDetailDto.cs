...
public sealed class ModeloDetailDto
{
    ...
    public List<ModeloScandalloLineDto> ScandalloLines { get; set; } = [];
    public List<ModeloColorLineDto> ColorLines { get; set; } = [];
    public List<ModeloFornituraLineDto> FornituraLines { get; set; } = [];
    public List<ModeloStockLineDto> StockLines { get; set; } = [];
}
