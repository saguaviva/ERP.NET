...
public sealed class MySqlTransportistaLegacySyncHandler : ILegacyModuleSyncHandler
{
    ...
    public MySqlTransportistaLegacySyncHandler(
    ...
    public string ModuleKey => LegacySyncModuleKeys.CrmCarriers;
    public string DisplayName => "CRM / Transportistas";
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var sharedColumns = await GetSharedColumnsAsync(legacyConnection, saasConnection, "trans", cancellationToken);
        ...
        {
            throw new InvalidOperationException("No se han encontrado las columnas mínimas necesarias para sincronizar la tabla trans.");
        }
        ...
        try
        {
            ...
            var import = await CopyRowsAsync(
                ...
                row =>
                {
                    mappings.Add(new LegacySyncMappingRecord
                    {
                        ...
                        LegacyDocumentType = "CARRIER",
                        LegacyDocumentNumber = row.EntityNumber,
                        TargetEntityName = "carrier",
            ...
            return new LegacySyncModuleRunResult
            {
                ...
                Summary = $"Transportistas replicados={import.ImportedRows}; errores={errors.Count}",
                Mappings = mappings,
                Errors = errors
            };
        }
        ...
        CancellationToken cancellationToken)
    {
        ...
        insertCommand.CommandText =
            $"""
            INSERT INTO `trans` ({insertColumnList})
