...
using Erp.Infrastructure.MySql.Mailing;
...
public static class DependencyInjection
{
    public static IServiceCollection AddMySqlInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<MySqlDocumentNumberingService>();
        services.AddScoped<IDocumentNumberingQueries>(provider => provider.GetRequiredService<MySqlDocumentNumberingService>());
        services.AddScoped<IDocumentNumberingService>(provider => provider.GetRequiredService<MySqlDocumentNumberingService>());
        services.AddScoped<IReportingQueries, MySqlReportingService>();
        services.AddScoped<IOperationalAlertQueries, MySqlOperationalAlertService>();
        services.AddScoped<MySqlMailingCampaignService>();
        services.AddScoped<IMailingCampaignQueries>(provider => provider.GetRequiredService<MySqlMailingCampaignService>());
        services.AddScoped<IMailingCampaignService>(provider => provider.GetRequiredService<MySqlMailingCampaignService>());
        ...
        services.AddScoped<MySqlSalesRemittanceService>();
        services.AddScoped<ISalesRemittanceQueries>(provider => provider.GetRequiredService<MySqlSalesRemittanceService>());
        services.AddScoped<ISalesRemittanceService>(provider => provider.GetRequiredService<MySqlSalesRemittanceService>());
