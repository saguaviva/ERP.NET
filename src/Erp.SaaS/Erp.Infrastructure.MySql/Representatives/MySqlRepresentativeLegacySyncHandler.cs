...
public sealed class MySqlRepresentativeLegacySyncHandler : ILegacyModuleSyncHandler
{
    ...
    public MySqlRepresentativeLegacySyncHandler(
    ...
    public string ModuleKey => LegacySyncModuleKeys.CrmRepresentatives;
    public string DisplayName => "CRM / Representantes";
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var sharedColumns = await GetSharedColumnsAsync(legacyConnection, saasConnection, "repres", cancellationToken);
        ...
        {
            throw new InvalidOperationException("No se han encontrado las columnas mínimas necesarias para sincronizar la tabla repres.");
        }
        ...
        try
        {
            ...
            var import = await CopyRowsAsync(
                ...
                row =>
                {
                    mappings.Add(new LegacySyncMappingRecord
                    {
                        ...
                        LegacyDocumentType = "REPRESENTATIVE",
                        LegacyDocumentNumber = row.EntityNumber,
                        TargetEntityName = "representative",
            ...
            return new LegacySyncModuleRunResult
            {
                ...
                Summary = $"Representantes replicados={import.ImportedRows}; errores={errors.Count}",
                Mappings = mappings,
                Errors = errors
            };
        }
        ...
        CancellationToken cancellationToken)
    {
        ...
        insertCommand.CommandText =
            $"""
            INSERT INTO `repres` ({insertColumnList})
