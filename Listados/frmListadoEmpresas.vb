...
Public Class frmlistadoEmpresas
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmlistadoEmpresas))
        '
        'btnTancar
        '
...
#End Region
    ...
    Shared frmChildForm As frmlistadoEmpresas
    Public Shared Function GetInstance(ByVal esEleccionLista As Short) As frmlistadoEmpresas
        If frmChildForm Is Nothing Then
            frmChildForm = New frmlistadoEmpresas
    ...
    Friend Overrides Sub CrearComandos()
        Try
            cmdSelect.CommandText = "SELECT filiales.*, " & _
                           ...
                           " FROM " & _
                           " filiales LEFT JOIN paises ON (paises.CODI = clients.PAIS) " & _
