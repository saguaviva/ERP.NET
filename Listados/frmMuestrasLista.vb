...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmMuestrasLista))
        '
        'btnTancar
        '
...
#End Region
    ...
    Shared frmChildForm As frmMuestrasLista
    Public Shared Function GetInstance(ByVal esEleccionLista As Short, ByVal center As Char) As frmMuestrasLista
        If frmChildForm Is Nothing Then
            frmChildForm = New frmMuestrasLista
...
#Region "VARIABLES"
    ...
    Public clienteSeleccionado As Integer = -1
...
#Region "ORGANIZAR"
    ...
    Friend Overrides Sub CrearComandos()
        Try
            If EsEleccionOListado = esEleccion Then
                If clienteSeleccionado = -1 Then
                    'Es eleccion de todas las muestras
                    cmdSelect.CommandText = "SELECT CODI, CLIENT, DESCRI, PREU FROM MOSTRES WHERE CENTRO = """ & centro & """ "
                Else
                    cmdSelect.CommandText = "SELECT CODI,DESCRI, PREU FROM MOSTRES WHERE CENTRO = """ & centro & """ AND CLIENT = """ & clienteSeleccionado & """ "
                End If
    ...
    Private Sub IniciarForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            tabla = tablaMuestras
            textoListado = rm.GetString("LCOMPLEMENTOS")
            IniciarListado()
    ...
    Friend Overrides Sub btnFormulario_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            Cursor = Cursors.WaitCursor
            Dim f As frmMuestras = frmMuestras.GetInstance()
    ...
    Friend Overrides Sub dg_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            Cursor = Cursors.WaitCursor
            If EsEleccionOListado = esEleccion Then
                If Not dg.Item(dg.Row) Is Nothing Then
            ...
            Else
                ...
                f.cargando = True
                f.muestraActual.CambiarAReg(dg.Item(dg.Row).Row, iraRegistroFila)
