...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmIVALista))
        '
        'btnTancar
        '
...
#End Region
    ...
    Shared frmChildForm As frmIVALista

    Public Shared Function GetInstance(ByVal esEleccionLista As Short) As frmIVALista
        If frmChildForm Is Nothing Then
            frmChildForm = New frmIVALista
    ...
    Friend Overrides Sub CrearComandos()
        Try
            cmdSelect.CommandText = "SELECT * FROM " & tabla & ""
    ...
    Friend Overrides Sub btnFormulario_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            Cursor = Cursors.WaitCursor
            Dim f As frmIVAForm = frmIVAForm.GetInstance()
    ...
    Friend Overrides Sub dg_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            Else
                ...
                Cursor = Cursors.Default
                cargando = True
                If f.IVAactual.centro <> dg.Item(dg.Row, "CENTRO") Then
                    f.IVAactual.centro = dg.Item(dg.Row, "CENTRO")
                    f.IVAactual.cambioCentro(GENERAL.nz(dg.Item(dg.Row, "CENTRO"), empresaPorDefecto), primero)
                    f.cboSeleccionCentro.SelectedValue = f.IVAactual.centro
                    'f.IVAactual.tabla.AcceptChanges()
                End If

                f.IVAactual.CambiarAReg(dg.Item(dg.Row, "CODI"), iraregistro)
                f.cargando = False
                cargando = False
                Me.Close()
            End If
