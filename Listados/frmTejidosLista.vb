...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmTejidosLista))
        '
        'btnTancar
        '
...
#End Region
    ...
    Shared frmChildForm As frmTejidosLista
    Public Shared Function GetInstance(ByVal esEleccionLista As Short, ByVal center As Char) As frmTejidosLista
        If frmChildForm Is Nothing Then
            frmChildForm = New frmTejidosLista
    ...
    Friend Overrides Sub HacerArraysCampoNombre()
        Try
            ...
            If EsEleccionOListado = esEleccion Then
                ...
                End With
            Else
                ArrayCampos = a.ObtenerArrayCamposTejidos
            End If
    ...
    Friend Overrides Sub CrearComandos()
        Try
            If EsEleccionOListado = esEleccion Then
                cmdSelect.CommandText = "SELECT CODI, DESCRI FROM TEIXITS WHERE CENTRO = """ & centro & """ "
            Else
                cmdSelect.CommandText = "SELECT * FROM TEIXITS WHERE CENTRO = """ & centro & """ "
            End If
    ...
    Private Sub IniciarForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            tabla = tablaTejidos
            textoListado = rm.GetString("LTEJIDOS")
            IniciarListado()
            dv.Sort = "CODI"
    ...
    Friend Overrides Sub btnFormulario_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            Cursor = Cursors.WaitCursor
            Dim f As frmTejidos = frmTejidos.GetInstance()
    ...
    Friend Overrides Sub dg_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            Else
                ...
                Cursor = Cursors.Default
                cargando = True
                If f.tejidoActual.centro <> dg.Item(dg.Row, "CENTRO") Then
                    f.tejidoActual.centro = dg.Item(dg.Row, "CENTRO")
                    f.tejidoActual.cambioCentro(GENERAL.nz(dg.Item(dg.Row, "CENTRO"), empresaPorDefecto), primero)
                    f.cboSeleccionCentro.SelectedValue = f.tejidoActual.centro
                    'f.tejidoActual.tabla.AcceptChanges()
                End If

                f.tejidoActual.CambiarAReg(dg.Item(dg.Row, "CODI"), iraregistro)
                f.cargando = False
                cargando = False
                Me.Close()
            End If
