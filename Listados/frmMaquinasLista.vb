...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmMaquinasLista))
        '
        'btnTancar
        '
...
#End Region
    ...
    Shared frmChildForm As frmMaquinasLista
    Public Shared Function GetInstance(ByVal esEleccionLista As Short) As frmMaquinasLista
        If frmChildForm Is Nothing Then
            frmChildForm = New frmMaquinasLista
    ...
    Friend Overrides Sub CrearComandos()
        Try
            If EsEleccionOListado = esEleccion Then
                cmdSelect.CommandText = "SELECT " & tabla & ".CODI, " & tabla & ".DESCRI, " & _
    ...
    Private Sub IniciarForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            tabla = tablaMaquinas
            textoListado = rm.GetString("LMAQUINAS")
            IniciarListado()
            dv.Sort = "CODI"
