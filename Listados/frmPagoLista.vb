...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmPagoLista))
        '
        'btnTancar
        '
...
#End Region
    ...
    Shared frmChildForm As frmPagoLista
    Public Shared Function GetInstance(ByVal esEleccionLista As Short) As frmPagoLista
        If frmChildForm Is Nothing Then
            frmChildForm = New frmPagoLista
...
#End Region
    ...
    Friend Overrides Sub HacerArraysCampoNombre()
        Try
            ...
            ArrayCampos = a.ObtenerArrayCamposForpag
    ...
    Private Sub IniciarForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            textoListado = "Llistat Formes Pagament"
            IniciarListado()
            dv.Sort = "CODI"
    ...
    Friend Overrides Sub btnFormulario_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            'Cursor = Cursors.WaitCursor
            'Dim f As frmPagoForm = frmPagoForm.GetInstance()
    ...
    Friend Overrides Sub dg_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            Else
                ...
                'Cursor = Cursors.Default
                'cargando = True
                'If f.formaActual.centro <> dg.Item(dg.Row, "CENTRO") Then
                '    f.formaActual.centro = dg.Item(dg.Row, "CENTRO")
                '    f.formaActual.cambioCentro(GENERAL.nz(dg.Item(dg.Row, "CENTRO"), empresaPorDefecto), primero)
                '    f.cboSeleccionCentro.SelectedValue = f.formaActual.centro
                '    'f.formaActual.tabla.AcceptChanges()
                'End If

                'f.formaActual.CambiarAReg(dg.Item(dg.Row, "CODI"), iraregistro)
                'f.cargando = False
                'cargando = False
                'Me.Close()
            End If
