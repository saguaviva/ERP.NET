...
Public Class frmProveedoresLista
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmProveedoresLista))
        '
        'btnTancar
        '
...
#End Region
    ...
    Shared frmChildForm As frmProveedoresLista
    Public Shared Function GetInstance(ByVal esEleccionLista As Short) As frmProveedoresLista
        If frmChildForm Is Nothing Then
            frmChildForm = New frmProveedoresLista
    ...
    Friend Overrides Sub HacerArraysCampoNombre()
        Try
            ...
            If EsEleccionOListado = esListado Then
                ArrayCampos = a.ObtenerArrayCamposProveedores
            Else
                With ArrayCampos
                    a.aCODIGO(3) = 1
    ...
    Private Sub IniciarForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            textoListado = rm.GetString("LPROVEEDORES")
            IniciarListado()
            dv.Sort = "CODI"
    ...
    Friend Overrides Sub btnFormulario_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            Cursor = Cursors.WaitCursor
            Dim f As frmProveedoresForm = frmProveedoresForm.GetInstance()
