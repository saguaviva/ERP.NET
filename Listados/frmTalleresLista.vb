...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmTalleresLista))
        '
        'btnTancar
        '
...
#End Region
    ...
    Shared frmChildForm As frmTalleresLista
    Public Shared Function GetInstance(ByVal esEleccionLista As Short) As frmTalleresLista
        If frmChildForm Is Nothing Then
            frmChildForm = New frmTalleresLista
    ...
    Friend Overrides Sub HacerArraysCampoNombre()
        Try
            ...
            If EsEleccionOListado = esListado Then
                ArrayCampos = a.ObtenerArrayCamposTalleres
            Else
                With ArrayCampos
                    a.aCODIGO(3) = 1
    ...
    Private Sub IniciarForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            tabla = tablaTalleres
            textoListado = rm.GetString("LTALLERES")
            IniciarListado()
            dv.Sort = "CODI"
    ...
    Friend Overrides Sub btnFormulario_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            Cursor = Cursors.WaitCursor
            Dim f As frmTalleresForm = frmTalleresForm.GetInstance()
    ...
    Friend Overrides Sub dg_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            Else
                ...
                Cursor = Cursors.Default
                cargando = True
                If f.tallerActual.centro <> dg.Item(dg.Row, "CENTRO") Then
                    f.tallerActual.centro = dg.Item(dg.Row, "CENTRO")
                    f.tallerActual.cambioCentro(GENERAL.nz(dg.Item(dg.Row, "CENTRO"), empresaPorDefecto), primero)
                    f.cboSeleccionCentro.SelectedValue = f.tallerActual.centro
                    'f.tallerActual.tabla.AcceptChanges()
                End If
                f.tallerActual.CambiarAReg(dg.Item(dg.Row, "CODI"), iraregistro)
                f.cargando = False
                cargando = False
                Me.Close()
            End If
