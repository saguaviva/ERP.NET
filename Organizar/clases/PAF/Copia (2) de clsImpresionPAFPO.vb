...
'0; 109; 91 (OSCURO)
'219; 222; 105 (CLARO)
Public Class clsImpresionPAFPONuevo
...
#Region "VARIABLES"
    ...
    Private strRegMercantil = rm.GetString("REGISTROMERCANTILCOESPUNT")
    Private lugarExp = "SANT VICENÇ DELS HORTS"
    ...
    Private tipoBorde As Excel.XlBorderWeight = Excel.XlBorderWeight.xlHairline
...
#Region "INICIALIZACION"
    ...
    Private Sub PonerDetallePacking()
        ...
        Try
            ...
            fuente.negrita = True
            xlsDir.PonerFuenteARango(filaActual, colVencimiento, filaActual + 8, colUltima, fuente)
            xlsDir.objHojaExcel.Cells(filaActual, colVencimiento).Value = "'" & rm.GetString("DETALLE").ToUpper
            filaActual = filaActual + 1
            With xlsDir.objHojaExcel
                xlsDir.PonerBordeARango(.Range(.Cells(filaActual, colVencimiento), .Cells(filaActual, colIMPORTVencim + (colIMPORTVencim - colVencimiento - 1))), _
                            Excel.XlBordersIndex.xlEdgeBottom, _
                            Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(filaActual, colIMPORTVencim), .Cells(filaActual + 5, colIMPORTVencim - 1)), _
                ...
                For i = 0 To detalleExtrangero.Count - 1
                    .Cells(filaActual + i, colVencimiento).Value = "'" & detalleExtrangero(i).Item("NOMBREDETALLE")
                    .Cells(filaActual + i, colIMPORTVencim).Value = "'" & detalleExtrangero(i).Item("DESCRIDETALLE")
                Next
                For i = 0 To detalleExtrangero2.Count - 1
                    .Cells(filaActual + i, colIniBanco + 2).Value = "'" & detalleExtrangero2(i).Item("TEXTO1")
                Next
    ...
    Public Sub New(ByVal document As String, _
           ...
           ByVal compraVent As String, _
           ByVal docu As DataView, _
           ByVal lineasDocu As DataView, _
           ByVal extrangero As Boolean, _
                ...
                Case Venta
                    Select Case documento
                        Case Pedido
                            xlsDir = New ExcelDirecto.ExcelDirecto(False, 63, 35, 43, 16, 8)
                        Case Albaran
                            xlsDir = New ExcelDirecto.ExcelDirecto(False, 62, 35, 44, 16, 8)
                        Case Factura
                            If esExtrangero Then
                        ...
                        Case Proforma
                            If esExtrangero Then
                                xlsDir = New ExcelDirecto.ExcelDirecto(False, 63, 15, 43, 26, 8)
                            Else
                                xlsDir = New ExcelDirecto.ExcelDirecto(False, 63, 35, 43, 16, 8)
                            End If
...
#Region "PONERCOLORESLOGOS"
    ...
    Private Sub PonerLogo()
        Try
            xlsDir.InsertPicture(pathLogo, _
                    xlsDir.objHojaExcel.Range(xlsDir.objHojaExcel.Cells(1, 1), _
    ...
    Private Sub PonerColorIndexCentro()
        Try
            ...
            If general.nz(doc(0).Item("centro"), "") = "C" Then
                'colorIndexCentro = 29
                Select Case documento
                    Case Pedido
...
#Region "CABECERAS"
        ...
        Try
            With xlsDir.objHojaExcel
                If documento = Factura Then
                    ...
                    '!!??!!?
                    ''xlsDir.InsertPicture(pathRec, .Cells(mas, colAlbar), False, True)
                End If
                ...
                If documento <> Pedido Then
                    ''xlsDir.InsertPicture(pathRec, .Cells(mas, colTipo), False, True)
                End If
                '!!??!!?
                ''xlsDir.InsertPicture(pathRec, .Cells(mas, colCodigo), False, True)
                ''xlsDir.InsertPicture(pathRec, .Cells(mas, colDescri), False, True)
                ''xlsDir.InsertPicture(pathRec, .Cells(mas, colColor), False, True)
                ''xlsDir.InsertPicture(pathRec, .Cells(mas, colTalla), False, True)
                ''xlsDir.InsertPicture(pathRec, .Cells(mas, colUnidades), False, True)
                ''xlsDir.InsertPicture(pathRec, .Cells(mas, colPrecio), False, True)
                'If documento <> Albaran Then 'xlsDir.InsertPicture(pathRec, .Cells(mas, colIMPORT), False, True)
            End With
        ...
        Try
            With xlsDir.objHojaExcel
                ...
                If documento <> Factura Then
                    ...
                    'xlsDir.InsertPicture(pathRec, .Cells(mas - 1, colTalla + 10), False, True)
                    coltallaa = colTalla
                ...
                'xlsDir.InsertPicture(pathRec, .Cells(mas, colColor), False, True)
                'xlsDir.InsertPicture(pathRec, .Cells(mas, colUnidades), False, True)
                'xlsDir.InsertPicture(pathRec, .Cells(mas, colIMPORT), False, True)
            End With
    ...
    Private Sub PonerCabeceraDetalleOrdenModelos(ByVal mas As Integer)
        Try
            With xlsDir.objHojaExcel
                Dim colTallaa As Short = colTalla
                .Cells(mas, colColor).Value = "'" & "  " & rm.GetString("COLOR").ToUpper
        ...
        Try
            With xlsDir.objHojaExcel
                ...
                If documento <> OrdenFabComplementos AndAlso (documento <> Albaran) Then ' AndAlso tipo <> Hilos) Then
                    ...
                    .Cells(mas, colIMPORT).Value = "'" & "  " & rm.GetString("IMPORTE").ToUpper
                    ''xlsDir.InsertPicture(pathRec, .Cells(mas, colPrecio), False, True)
                    ''xlsDir.InsertPicture(pathRec, .Cells(mas, colDTO), False, True)
                    ''xlsDir.InsertPicture(pathRec, .Cells(mas, colIMPORT), False, True)
                End If
                ...
                If documento = OrdenFabComplementos Then
                    .Cells(mas, colIMPORT).Value = "'" & "  " & rm.GetString("IMPORTE").ToUpper
                End If
                'If documento = Factura Then 'xlsDir.InsertPicture(pathRec, .Range("A" & mas & ":A" & mas), False, True)

                ''xlsDir.InsertPicture(pathRec, .Cells(mas, colCodigo), False, True)
                ''xlsDir.InsertPicture(pathRec, .Cells(mas, colDescri), False, True)
                'If tipo = Tejido Or tipo = Muestra Then 'xlsDir.InsertPicture(pathRec, .Cells(mas, colColor), False, True)
                'If tipo = Tejido Then 'xlsDir.InsertPicture(pathRec, .Cells(mas, colMaquina), False, True)
                ''xlsDir.InsertPicture(pathRec, .Cells(mas, colUnidades), False, True)
            End With
            ...
            With xlsDir.objHojaExcel
                Select Case documento
                    Case Pedido
                        ...
                        xlsDir.PonerBordeARangoRectangulo(mas, 1, mas + 1, colCodigo + 25, Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
    ...
    Private Function PonerCabeceraDetalle(ByVal hoja As Integer) As Integer
        ...
        If hoja = 1 Then mas = xlsDir.iniDetalle
                        ...
                        Select Case documento
                            Case Albaran, Factura, Pedido, Proforma
                                Select Case MODELO
                                    ...
                                    Case False : PonerCabeceraDetalleComplTej(mas)
                                End Select
                            Case OrdenModelos : PonerCabeceraDetalleOrdenModelos(mas)
                        End Select
                End Select
                xlsDir.PonerBordeARango(.Range(.Cells(mas, 2), .Cells(mas, colUltima)), Excel.XlBordersIndex.xlEdgeBottom, _
                             Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
        ...
        End Try
    End Function
    Private Sub PonerCabeceraInfoPersona()
        Dim str As String
        Try
            Select Case compraVenta
                Case Compra
                    Select Case documento
                        Case Pedido
                            ...
                            str = "SELECT CODI, NOM, DOM, CP, PROV, POB, NIF, EMAIL1 FROM " & tablaProveedores & " " & _
            ...
            If documento <> OrdenModelos Then
                If documento = Factura Then
                    PonerInformacionPersonaFactura(str)
                Else
                    PonerInformacionPersona(str)
                End If
            End If
            PonerTipoDocumento()
    ...
    End Sub
    Private Sub PonerInformacionPersona(ByVal str As String)
        ...
        Try
            ...
            While dareader.Read
                With dareader
                    ...
                    fuente.nombre = "Verdana"
                    fuente.tamaño = 10
                    xlsDir.PonerFuenteARango("E5:E10", fuente)
                    With xlsDir.objHojaExcel
                        xlsDir.PonerImagenRepetidaEnFilas(pathRec, 8, New String() {colDescripcionDocumento, colUltima}, False, False, True)
                        xlsDir.PonerImagenRepetidaEnFilas(pathRec, 14, New String() {colDescripcionDocumento, colUltima}, False, False, True)
                        ...
                        .Cells(8, colDescripcionDocumento).Value = "'" & "   " & dareader.Item("NOM") & "      " & dareader.Item("CODI")
                        .Cells(9, colDescripcionDocumento).Value = "'" & "   " & DirectCast(dareader.Item("DOM"), String).Replace(vbCrLf, " ")
                        .Cells(10, colDescripcionDocumento).Value = "'" & "   " & dareader.Item("CP") & " " & dareader.Item("POB")
                        .Cells(11, colDescripcionDocumento).Value = "'" & "   " & dareader.Item("PROV")
                        Try
                            If general.nz(dareader.Item("PAIS"), "") <> "" Then
                                .Cells(12, colDescripcionDocumento - 5).Value = "'" & "    " & dareader.Item("PAIS")
                            End If
                        Catch ex As Exception

                        End Try

                        .Cells(13, colDescripcionDocumento).Value = "'" & "   " & dareader.Item("NIF")
        ...
        End Try
    End Sub
    Private Sub PonerInformacionPersonaFactura(ByVal str As String)
        Dim cmdSel As New MySqlCommand
        Dim dareader As MySqlDataReader
        Dim fuente As ExcelDirecto.ExcelDirecto.Fuente
        Try
            ...
            With xlsDir.objHojaExcel
                While dareader.Read
                    ...
                    'xlsDir.PonerImagenRepetidaEnFilas(pathRec, 10, New String() {colDescripcionDocumento - 5, colUltima}, False, False, True)
                    'xlsDir.PonerImagenRepetidaEnFilas(pathRec, 19, New String() {colDescripcionDocumento - 5, colUltima}, False, False, True)
                    xlsDir.PonerBordeARango(8, colDescripcionDocumento - 2, 10, colDescripcionDocumento - 2, Excel.XlBordersIndex.xlEdgeLeft, Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                    xlsDir.PonerBordeARango(8, colDescripcionDocumento - 4, 8, colDescripcionDocumento - 2, Excel.XlBordersIndex.xlEdgeLeft, Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                    ...
                    If esExtrangero Then
                        ...
                        .Cells(8, colDescripcionDocumento - 5).Value = "'" & rm.GetString("COMPRADOR").ToUpper
                    End If
                    .Cells(10, colDescripcionDocumento - 5).Value = "'" & "    " & dareader.Item("NOM") & "      " & dareader.Item("CODI")
                    .Cells(11, colDescripcionDocumento - 5).Value = "'" & "    " & DirectCast(dareader.Item("DOM"), String).Replace(vbCrLf, " ")
                    .Cells(12, colDescripcionDocumento - 5).Value = "'" & "    " & dareader.Item("CP") & " " & dareader.Item("POB")
                    .Cells(13, colDescripcionDocumento - 5).Value = "'" & "    " & dareader.Item("PROV")
                    If general.nz(dareader.Item("PAIS"), "") <> "" Then
                        .Cells(14, colDescripcionDocumento - 5).Value = "'" & "    " & dareader.Item("PAIS")
                    End If
                    .Cells(19, colDescripcionDocumento - 5).Value = "'" & "    " & dareader.Item("NIF")
                    xlsDir.PonerBordeARango(19, colUltima - 2, 21, colUltima - 2, Excel.XlBordersIndex.xlEdgeLeft, Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                    xlsDir.PonerBordeARango(19, colUltima - 2, 19, colUltima, Excel.XlBordersIndex.xlEdgeLeft, Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)

                End While
                'Ponermos la direccion de envio en caso de empresa extrangera
                If esExtrangero And general.nz(doc(0).Item("DOM"), "") <> "" Then
                    fuente.negrita = True
                    xlsDir.PonerFuenteARango(21, colDescripcionDocumento - 5, 21, colDescripcionDocumento - 5, fuente)
                    fuente.negrita = False
                    .Cells(21, colDescripcionDocumento - 5).Value = "'" & rm.GetString("DIRECCIONENVIO").ToUpper
                    xlsDir.PonerBordeARangoRectangulo(22, colDescripcionDocumento - 5, 22 + 6, colUltima - 1, _
                       Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                    xlsDir.AlinearRango(22, colDescripcionDocumento - 5, 22, colDescripcionDocumento - 5, ExcelDirecto.ExcelDirecto.Alineacion.Izquierda, ExcelDirecto.ExcelDirecto.Alineacion.Superior)
                    xlsDir.Juntar(22, colDescripcionDocumento - 5, 22 + 6, colUltima - 1)
                    xlsDir.AlinearRango(22, colDescripcionDocumento - 5, 22 + 6, colUltima - 1, ExcelDirecto.ExcelDirecto.Alineacion.Izquierda, ExcelDirecto.ExcelDirecto.Alineacion.Superior)
                    .Cells(22, colDescripcionDocumento - 5).Value = "'" & domEnvio
                    xlsDir.PonerBordeARango(22, colUltima - 2, 24, colUltima - 2, Excel.XlBordersIndex.xlEdgeLeft, Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                    xlsDir.PonerBordeARango(22, colUltima - 2, 22, colUltima, Excel.XlBordersIndex.xlEdgeLeft, Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
    ...
    Private Sub PonerTipoDocumento()
        Dim fuente As ExcelDirecto.ExcelDirecto.Fuente
        Try
                ...
                Select Case compraVenta
                    Case Compra
                        ...
                        Select Case documento
                            Case Pedido
                                Select Case tipo
                                    Case Tejido
                                        xlsDir.Juntar(2, colDescripcionDocumento, 3, colUltima - 1)
                                        .Cells(2, colDescripcionDocumento).Value = "'" & rm.GetString("PEDIDOCOMPRATEJIDO").ToUpper
                                        xlsDir.objLibroExcel.asuntoMail = rm.GetString("PTEJIDO")
                                    Case Hilos
                                        xlsDir.Juntar(2, colDescripcionDocumento, 3, colUltima - 1)
                                        .Cells(2, colDescripcionDocumento).Value = "'" & rm.GetString("PEDIDOCOMPRAHILO").ToUpper
                                        xlsDir.objLibroExcel.asuntoMail = rm.GetString("PHILO")
                                    Case Fornitura
                                        xlsDir.Juntar(2, colDescripcionDocumento, 3, colUltima - 1)
                                        .Cells(2, colDescripcionDocumento).Value = "'" & rm.GetString("PEDIDOCOMPRAFORNI").ToUpper
                                        xlsDir.objLibroExcel.asuntoMail = rm.GetString("PFORNI")
                                End Select
                                'Solo Albaranes de compra de hilos
                            Case Albaran
                                xlsDir.Juntar(2, colDescripcionDocumento, 3, colUltima - 1)
                                .Cells(2, colDescripcionDocumento).Value = "'" & rm.GetString("ALBARANESENTREGAHILOS").ToUpper
                                xlsDir.objLibroExcel.asuntoMail = rm.GetString("AENTREGAHILOS")
                            Case OrdenFabComplementos
                                xlsDir.Juntar(2, colDescripcionDocumento, 3, colUltima - 1)
                                .Cells(2, colDescripcionDocumento).Value = "'" & rm.GetString("ORDENCOMPLEMENTO").ToUpper
                    ...
                    Case Venta
                        ...
                        Select Case documento
                            ...
                            Case OrdenModelos
                                fuente.tamaño = 12
                                xlsDir.Juntar(2, colDescripcionDocumento - 6, 3, colUltima - 1)
                                .Cells(2, colDescripcionDocumento - 6).Value = "'" & rm.GetString("ORDENESMODELOS").ToUpper
                                xlsDir.objLibroExcel.asuntoMail = rm.GetString("ORDENESMODELOS")
                                xlsDir.PonerFuenteARango(2, colDescripcionDocumento - 6, 2, colDescripcionDocumento - 6, fuente)
                            Case Pedido
                                xlsDir.Juntar(2, colDescripcionDocumento - 6, 3, colUltima - 1)
                                .Cells(2, colDescripcionDocumento - 6).Value = "'" & rm.GetString("PEDIDO").ToUpper
                                xlsDir.objLibroExcel.asuntoMail = rm.GetString("PEDIDO")
                            Case Albaran
                                xlsDir.Juntar(2, colDescripcionDocumento - 6, 3, colUltima - 1)
                                .Cells(2, colDescripcionDocumento - 6).Value = "'" & rm.GetString("ALBARAN").ToUpper
                                xlsDir.objLibroExcel.asuntoMail = rm.GetString("ALBARAN")
                            Case Proforma
                                xlsDir.Juntar(2, colDescripcionDocumento - 6, 3, colUltima - 1)
                                .Cells(2, colDescripcionDocumento - 6).Value = "'" & rm.GetString("PROFORMA").ToUpper
                                xlsDir.objLibroExcel.asuntoMail = rm.GetString("PROFORMA")
                            Case Factura
                                xlsDir.Juntar(2, colDescripcionDocumento - 6, 3, colUltima - 1)
                                .Cells(2, colDescripcionDocumento - 6).Value = "'" & rm.GetString("FACTURA").ToUpper
...
#Region "DETALLE"
        ...
        Try
            If hojaNueva Then
                ...
                Else
                    ...
                    PonerBordesDetalle(xlsDir.iniDetalleNoPrimera + ((hoja - 1) * xlsDir.tamHoja), filaMAX, hoja)
                End If
            End If
            If hoja = 1 Then fil = pos
            Dim x As Integer = xlsDir.tamHoja * (hoja - 1) + fil

            If hoja = 1 Then : x = x + xlsDir.iniDetalle + 1 : Else : x = x + xlsDir.iniDetalleNoPrimera : End If
            If xlsDir.Cabe(x + 15, hoja) Then
                        ...
                        Select Case documento
                            Case Pedido, Albaran, Factura, Proforma
                                Select Case MODELO
                                    ...
                                    Case False : Return PonerArticuloComplementoTejido(x, pos)
                                End Select
    ...
    Private Sub PonerBordesDetallaOrdenesModelos(ByVal x As Integer, ByVal y As Integer)
        Try
            With xlsDir.objHojaExcel
                xlsDir.PonerBordeARango(.Range(.Cells(x, colTipo), .Cells(y, colTipo)), Excel.XlBordersIndex.xlEdgeLeft, _
                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colColor), .Cells(y, colColor)), Excel.XlBordersIndex.xlEdgeLeft, _
                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colTalla), .Cells(y, colTalla)), Excel.XlBordersIndex.xlEdgeLeft, _
                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colTalla + 3), .Cells(y, colTalla + 3)), Excel.XlBordersIndex.xlEdgeLeft, _
                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colTalla + 6), .Cells(y, colTalla + 6)), Excel.XlBordersIndex.xlEdgeLeft, _
                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colTalla + 9), .Cells(y, colTalla + 9)), Excel.XlBordersIndex.xlEdgeLeft, _
                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colTalla + 12), .Cells(y, colTalla + 12)), Excel.XlBordersIndex.xlEdgeLeft, _
                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colTalla + 15), .Cells(y, colTalla + 15)), Excel.XlBordersIndex.xlEdgeLeft, _
                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colTalla + 18), .Cells(y, colTalla + 18)), Excel.XlBordersIndex.xlEdgeLeft, _
                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colTalla + 21), .Cells(y, colTalla + 21)), Excel.XlBordersIndex.xlEdgeLeft, _
                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colTalla + 24), .Cells(y, colTalla + 24)), Excel.XlBordersIndex.xlEdgeLeft, _
                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colTalla + 27), .Cells(y, colTalla + 27)), Excel.XlBordersIndex.xlEdgeLeft, _
                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colUnidades), .Cells(y, colUnidades)), Excel.XlBordersIndex.xlEdgeLeft, _
                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
    ...
    Private Sub PonerBordesDetalleModeloFactura(ByVal x As Integer, ByVal y As Integer)
        Try
            With xlsDir.objHojaExcel
                ...
                xlsDir.PonerBordeARango(.Range(.Cells(x, colAlbar), .Cells(y, colAlbar)), Excel.XlBordersIndex.xlEdgeLeft, _
                                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colTipo), .Cells(y, colTipo)), Excel.XlBordersIndex.xlEdgeLeft, _
                                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colCodigo), .Cells(y, colCodigo)), Excel.XlBordersIndex.xlEdgeLeft, _
                                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colDescri), .Cells(y, colDescri)), Excel.XlBordersIndex.xlEdgeLeft, _
                                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colColor), .Cells(y, colColor)), Excel.XlBordersIndex.xlEdgeLeft, _
                                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colUnidades), .Cells(y, colUnidades)), Excel.XlBordersIndex.xlEdgeLeft, _
                                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colPrecio), .Cells(y, colPrecio)), Excel.XlBordersIndex.xlEdgeLeft, _
                                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                xlsDir.PonerBordeARango(.Range(.Cells(x, colIMPORT), .Cells(y, colIMPORT)), Excel.XlBordersIndex.xlEdgeLeft, _
                                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
            End With
        ...
        Try
            With xlsDir.objHojaExcel
                ...
                Select Case compraVenta
                    ...
                    Case Compra
                        If documento = Factura Then
                            xlsDir.PonerBordeARango(.Range("A" & x & ":A" & y), Excel.XlBordersIndex.xlEdgeLeft, _
                                                                Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                        End If
                        ...
                        If tipo = Fornitura Then
                            xlsDir.PonerBordeARango(.Range(.Cells(x, colTalla), .Cells(y, colTalla)), Excel.XlBordersIndex.xlEdgeLeft, _
                                                         Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                        End If
                        If tipo = Tejido Then xlsDir.PonerBordeARango(.Range(.Cells(x, colMaquina), .Cells(y, colMaquina)), Excel.XlBordersIndex.xlEdgeLeft, _
                             Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                        ...
                        If documento <> OrdenFabComplementos Then
                            xlsDir.PonerBordeARango(.Range(.Cells(x, colPrecio), .Cells(y, colPrecio)), Excel.XlBordersIndex.xlEdgeLeft, _
                                Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                            xlsDir.PonerBordeARango(.Range(.Cells(x, colDTO), .Cells(y, colDTO)), Excel.XlBordersIndex.xlEdgeLeft, _
                                 Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
        ...
        Try
            If MODELO = True Then
                cmd = New MySqlCommand("SELECT " & _
                    " FACTUR.DATA AS FECHA FROM DFACTU " & _
                    " LEFT JOIN FACTUR ON (FACTUR.FRA = DFACTU.ALBAR) " & _
                    " WHERE " & _
                    " DFACTU.FRA = """ & doc(0).Item("FRA") & """ " & _
                    " AND DFACTU.DOCUMENT = ""F"" " & _
                    " AND DFACTU.TIPUS = ""P"" " & _
                    " AND DFACTU.CENTRO = """ & doc(0).Item("CENTRO") & """ " & _
                    " AND FACTUR.TIPUS = ""P"" " & _
                    " AND FACTUR.CENTRO = """ & doc(0).Item("CENTRO") & """ " & _
    ...
    Private Sub PonerDetalle()
        ...
        Try
            ...
            For i = 0 To lineasDoc.Count - 1
                ...
                fcargando.lblstatus.Text = roundnum(100 * i / lineasDoc.Count, 0) & " % " & rm.GetString("COMPLETADO")
...
#Region "TOTALES/PIEDETALLE"
    ...
    Private Sub PonerRegistroMercantil(ByVal hoja As Integer)
        ...
        Try
            If hoja = 1 Then : inicio = xlsDir.iniDetalle
            Else : inicio = xlsDir.tamHoja * (hoja - 1) + xlsDir.iniDetalleNoPrimera : End If
            ...
            Select Case general.nz(doc(0).Item("centro"), "")
                Case "C" : xlsDir.objHojaExcel.Cells(inicio, 1).Value = rm.GetString("REGISTROMERCANTILCOESPUNT")
                Case "O" : xlsDir.objHojaExcel.Cells(inicio, 1).Value = rm.GetString("REGISTROMERCANTILCYCO")
                Case "M" : xlsDir.objHojaExcel.Cells(inicio, 1).Value = rm.GetString("REGISTROMERCANTILCOMPLETEX")
                Case "I" : xlsDir.objHojaExcel.Cells(inicio, 1).Value = rm.GetString("REGISTROMERCANTILINFINIPUNT")
            End Select
            ...
            Select Case compraVenta
                Case Venta
                    With xlsDir.objHojaExcel
                        ...
                        'If documento = Factura Then xlsDir.InsertPicture(curdir & "\imagenes\recAzul.JPG", .Range(.Cells(filaActual, colAlbar - 1), .Cells(filaActual, colAlbar - 1)), False, False, True, -1, -1, 4)
                        Select Case MODELO
                            Case False
                                'xlsDir.PonerImagenRepetidaEnFilas(curdir & "\imagenes\recAzul.JPG", filaActual, _
                                'New String() {colTipo - 1, colCodigo - 1, colDescri - 1, colColor - 1, _
                                'colTalla - 1, colUnidades - 1, colPrecio - 1}, False, False, True, -1, -1, 4)
                            Case True
                                'xlsDir.PonerImagenRepetidaEnFilas(curdir & "\imagenes\recAzul.JPG", filaActual, _
                                'New String() {colTipo - 1, colCodigo - 1, colDescri - 1, colColor - 1, colTalla - 1, colTalla + 3 - 1, colTalla + 6 - 1, _
                                'colTalla + 9 - 1, colTalla + 12 - 1, colTalla + 15 - 1, colTalla + 18 - 1, colTalla + 21 - 1, colTalla + 24 - 1, colTalla + 27 - 1, colUnidades - 1, colIMPORT - 1}, False, False, True, -1, -1, 4)
                        End Select
                ...
                Case Compra
                    PonerRectangulosParteInferior(filaActual)
                    With xlsDir.objHojaExcel
    ...
    Private Sub PonerDatosBanco()
        Try
            With xlsDir.objHojaExcel
                If esExtrangero Then
                    xlsDir.PonerBordeARangoRectangulo(filaActual + 1, colIniBanco, filaActual + 3, colIniBanco + 39, Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                ...
                Else
                    ...
                    .Cells(filaActual + 1, colIniBanco).Value = "'" & rm.GetString("BANCO")
                    .Cells(filaActual + 1, colIniBanco + 6).Value = "'" & doc(0).Item("NOMBANC")

                    ' .Cells(filaActual + 2, colIniBanco).Value = "'" & rm.GetString("DIRECCION")
                    ' .Cells(filaActual + 2, colIniBanco + 6).Value = "'" &general.nz(doc(0).Item("OFI"), "")

                    .Cells(filaActual + 3, colIniBanco).Value = "'" & rm.GetString("NUMCTA")
                    .Cells(filaActual + 3, colIniBanco + 6).Value = "'" & IIf(nzn(doc(0).Item("BANC"), 0) = 0, "", doc(0).Item("BANC")) & _
                                                                    " " & IIf(nzn(doc(0).Item("COFI"), 0) = 0, "", doc(0).Item("COFI")) & _
                                                                    " " & IIf(nzn(doc(0).Item("DC"), 0) = 0, "", doc(0).Item("DC")) & _
                                                                    " " & IIf(nzn(doc(0).Item("CTA"), 0) = 0, "", doc(0).Item("CTA"))
    ...
    Private Sub PonerRectangulosParteInferior(ByVal inicio As Integer)
        Try
            ...
            With xlsDir.objHojaExcel
                ...
                xlsDir.InsertPicture(CurDir() & "\imagenes\recAzul.JPG", .Range(.Cells(inicio, colCodigo - 1), _
                                        .Cells(inicio, colCodigo - 1)), False, False, True, -1, -1, 4)
                xlsDir.InsertPicture(CurDir() & "\imagenes\recAzul.JPG", .Range(.Cells(inicio, colDescri - 1), _
                                        .Cells(inicio, colDescri - 1)), False, False, True, -1, -1, 4)
                If tipo = Tejido OrElse tipo = Muestra Then _
                    xlsDir.InsertPicture(CurDir() & "\imagenes\recAzul.JPG", .Range(.Cells(inicio, colColor - 1), _
                                        .Cells(inicio, colColor - 1)), False, False, True, -1, -1, 4)
                If tipo = Tejido Then _
                    xlsDir.InsertPicture(CurDir() & "\imagenes\recAzul.JPG", .Range(.Cells(inicio, colMaquina - 1), _
                                        .Cells(inicio, colMaquina - 1)), False, False, True, -1, -1, 4)
                xlsDir.InsertPicture(CurDir() & "\imagenes\recAzul.JPG", .Range(.Cells(inicio, colUnidades - 1), _
                                        .Cells(inicio, colUnidades - 1)), False, False, True, -1, -1, 4)
                If documento <> OrdenFabComplementos AndAlso (documento <> Albaran) Then ' AndAlso tipo <> Hilos) Then
                    xlsDir.InsertPicture(CurDir() & "\imagenes\recAzul.JPG", .Range(.Cells(inicio, colPrecio - 1), _
                        .Cells(inicio, colPrecio - 1)), False, False, True, -1, -1, 4)
                    xlsDir.InsertPicture(CurDir() & "\imagenes\recAzul.JPG", .Range(.Cells(inicio, colDTO - 1), _
                                            .Cells(inicio, colDTO - 1)), False, False, True, -1, -1, 4)
                    xlsDir.InsertPicture(CurDir() & "\imagenes\recAzul.JPG", .Range(.Cells(inicio, colIMPORT - 1), _
            ...
            With xlsDir.objHojaExcel
                        ...
                        Select Case documento
                            Case Factura
                                Select Case MODELO
                                    Case True
                                        'xlsDir.PonerImagenRepetidaEnFilas(curdir & "\imagenes\recAzul.JPG", filaActual, _
                                        'New String() {colAlbar - 1, colTipo - 1, colCodigo - 1, colDescri - 1, colColor - 1, _
                                        '        colUnidades - 1, colPrecio - 1, colIMPORT - 1}, False, False, True, -1, -1, 4)

                                    Case False
                                        'xlsDir.PonerImagenRepetidaEnFilas(curdir & "\imagenes\recAzul.JPG", filaActual, _
                                        '    New String() {colAlbar - 1, colTipo - 1, colCodigo - 1, colDescri - 1, colColor - 1, _
                                        '    colTalla - 1, colUnidades - 1, colPrecio - 1, colIMPORT - 1}, False, False, True, -1, -1, 4)

                                End Select
                            Case OrdenModelos
                                'xlsDir.PonerImagenRepetidaEnFilas(curdir & "\imagenes\recAzul.JPG", filaActual, _
                                '    New String() {colColor - 1, colTalla - 1, colTalla + 3 - 1, colTalla + 6 - 1, _
                                '    colTalla + 9 - 1, colTalla + 12 - 1, colTalla + 15 - 1, colTalla + 18 - 1, colTalla + 21 - 1, colTalla + 24 - 1, colTalla + 27 - 1, colUnidades - 1}, False, False, True, -1, -1, 4)
                            Case Pedido
                                'xlsDir.PonerImagenRepetidaEnFilas(curdir & "\imagenes\recAzul.JPG", filaActual, _
                                '    New String() {colCodigo - 1, colDescri - 1, colColor - 1, _
                                '    colTalla - 1, colUnidades - 1, colPrecio - 1, colIMPORT - 1}, False, False, True, -1, -1, 4)
                            Case Else
                                'xlsDir.PonerImagenRepetidaEnFilas(curdir & "\imagenes\recAzul.JPG", filaActual, _
                                '    New String() {colTipo - 1, colCodigo - 1, colDescri - 1, colColor - 1, _
                ...
                If xlsDir.Cabe(filaActual + 5, hoja) Then
                    ...
                    xlsDir.PonerBordeARangoRectangulo(x, colBrutoTotal, xx, colDTOTotal, _
                                    Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                    'xlsDir.InsertPicture(pathRec, x, colBrutoTotal, x, colBrutoTotal, False, True, True)
                    ...
                    .Cells(xx, colBrutoTotal).Value = "'" & Format(nzn(doc(0).Item("BRUT1"), 0), "#,##0.00") '"'" & nzn(doc(0).Item("BRUT1"), 0) & " €"
                    ...
                    xlsDir.PonerBordeARangoRectangulo(x, colDTOTotal, xx, colBaseTotal, _
                          Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                    'xlsDir.InsertPicture(pathRec, x, colDTOTotal, x, colDTOTotal, False, True, True)
                    ...
                    .Cells(xx, colDTOTotal).Value = "'" & Format(nzn(doc(0).Item("DTE1"), 0), "#,##0.00") '"'" & nzn(doc(0).Item("DTE1"), 0) & " €"

                    'BASE
                    xlsDir.PonerBordeARangoRectangulo(x, colBaseTotal, xx, colIVATotal, _
                         Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                    'xlsDir.InsertPicture(pathRec, x, colBaseTotal, x, colBaseTotal, False, True, True)
                    ...
                    .Cells(xx, colBaseTotal).Value = "'" & Format(nzn(doc(0).Item("BASE1"), 0), "#,##0.00") '"'" & nzn(doc(0).Item("BASE1"), 0) & " €"


                    'IVA
                    xlsDir.PonerBordeARangoRectangulo(x, colIVATotal, xx, colRETotal, _
                            Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                    'xlsDir.InsertPicture(pathRec, x, colIVATotal, x, colIVATotal, False, True, True)
                    ...
                    .Cells(xx, colIVATotal).Value = "'" & Format(nzn(doc(0).Item("IVA1"), 0), "#,##0.00") '"'" & doc(0).Item("IVA1") & " €"


                    'RE
                    xlsDir.PonerBordeARangoRectangulo(x, colRETotal, xx, colTotalTotal, _
                        Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                    'xlsDir.InsertPicture(pathRec, x, colRETotal, x, colRETotal, False, True, True)
                    ...
                    .Cells(xx, colRETotal).value = "'" & Format(nzn(doc(0).Item("RE1"), 0), "#,##0.00") '"'" & nzn(doc(0).Item("RE1"), 0) & " €"


                    'TOTAL
                    xlsDir.PonerBordeARangoRectangulo(x, colTotalTotal, xx, colUltima - 1, _
                            Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                    'xlsDir.InsertPicture(pathRec, x, colTotalTotal, x, colTotalTotal, False, True, True)
                    ...
                    .Cells(xx, colTotalTotal).Value = "'" & Format(nzn(doc(0).Item("TOTAL"), 0), "#,##0.00") '"'" & nzn(doc(0).Item("TOTAL"), 0) & " €"
    ...
    Private Sub PonerPiePagina()
        ...
        Try
            ...
            fuente.nombre = "Tahoma"
            fuente.tamaño = 6
            fuente.colorIndex = colorIndexCentro
            fuente.negrita = False
        ...
        End Try
    End Sub
    Private Function PonerObservaciones()
        Dim fuente As ExcelDirecto.ExcelDirecto.Fuente
        Try
            fuente.nombre = "Tahoma"
            fuente.tamaño = "8"
            With xlsDir.objHojaExcel
                ...
                If documento = Pedido OrElse documento = OrdenModelos Then
                    xlsDir.PonerBordeARangoRectangulo(filaActual, colBrutoTotal, filaActual + 7, colUltima - 1, _
                              Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                    ...
                    Select Case compraVenta
                        Case Compra
                            Select Case documento
                                Case OrdenFabComplementos
                                    ...
                                    xlsDir.PonerBordeARangoRectangulo(filaActual, colCodigo, filaActual + 6, colUltima - 1, _
                                        Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                                ...
                                Case Albaran
                                    Select Case tipo
                                        Case Hilos
                                            ...
                                            xlsDir.PonerBordeARangoRectangulo(filaActual, colObserv, filaActual + 6, colUltima - 1, _
                                                Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)
                                            xlsDir.AlinearRango(filaActual, colObserv, filaActual, colObserv, ExcelDirecto.ExcelDirecto.Alineacion.Izquierda, ExcelDirecto.ExcelDirecto.Alineacion.Superior)
                        ...
                        Case Venta
                            Select Case documento
                                Case Albaran
                                    'CONFORME CLIENTE
                                    xlsDir.PonerBordeARangoRectangulo(.Range(.Cells(filaActual, colPrimera), .Cells(filaActual + 7, colObserv - 1)), _
                                                                        Excel.XlBordersIndex.xlEdgeTop, _
                                                                        Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)

                                    'OBSERVACIONES
                                    xlsDir.PonerBordeARangoRectangulo(.Range(.Cells(filaActual, colPrimera), .Cells(filaActual + 7, colUltima - 1)), _
                                                                        Excel.XlBordersIndex.xlEdgeTop, _
                                                                        Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)

                                    xlsDir.PonerBordeARangoRectangulo(.Range(.Cells(filaActual, colPrimera), .Cells(filaActual, colUltima - 1)), _
                                                           Excel.XlBordersIndex.xlEdgeTop, _
                                                           Excel.XlLineStyle.xlContinuous, tipoBorde, colorIndexDocumento)

                                    xlsDir.Juntar(filaActual + 1, colPrimera, filaActual + 7, colObserv - 1)
                                    xlsDir.Juntar(filaActual + 1, colObserv, filaActual + 7, colUltima - 1)

                                    xlsDir.AlinearRango(filaActual, colPrimera, filaActual + 1, colPrimera, ExcelDirecto.ExcelDirecto.Alineacion.Centro)
                                    xlsDir.AlinearRango(filaActual, colObserv, filaActual + 1, colObserv, ExcelDirecto.ExcelDirecto.Alineacion.Centro)

                                    xlsDir.Juntar(filaActual, colPrimera, filaActual, colObserv - 1)
                                    .Cells(filaActual, colPrimera).Value = "'" & rm.GetString("CONFOMECLIENTE").ToUpper
                                    xlsDir.Juntar(filaActual, colObserv, filaActual, colUltima - 1)
                                    .Cells(filaActual, colObserv).Value = "'" & rm.GetString("OBSERVACIONES").ToUpper
                                    .Cells(filaActual + 1, colObserv).Value = "'" & DirectCast(general.nz(doc(0).Item("OBSERV"), ""), String).Replace(vbCrLf, vbLf)
                            End Select
                    End Select
                End If
            End With
...
#Region "ORGANIZAR"
    ...
    Private Sub TratamientoFinal()
        Try
            ...
            xlsDir.m_Excel.Visible = True
            xlsDir.AsignarMacro(xlsDir.AñadirBoton(1, 23, 1, 23 + 5, 50, 25, rm.GetString("ENVIARPORMAIL")), "EnviarMailEnCuerpo2")
            ...
            Select Case compraVenta
                ...
                Case Venta
                    Select Case documento
                        ...
                        Case Factura : xlsDir.AñadirHoja(rm.GetString("ALBARANTEJIDO"), "Arial")
                        Case Proforma : xlsDir.AñadirHoja(rm.GetString("ALBARANTEJIDO"), "Arial")
...
#Region "RECIBOS"
    ...
    Private Sub obtenerDatosCliente(ByVal cliente As Integer, ByRef strCliente As String, ByRef strBanco As String, ByRef strDC As String, ByRef strNumCuenta As String, ByRef strCOFI As String, ByRef strBANC As String)
        Dim cmdSel As New MySqlCommand
        Dim dareader As MySqlDataReader
        Dim strSQL As String
        Try
            strSQL = "SELECT CLIENTS.NOM, " & _
                        " CLIENTS.DOM, " & _
                        " CLIENTS.CP,  " & _
                        " CLIENTS.PROV,  " & _
                        " CLIENTS.POB,  " & _
                        " CLIENTS.NIF, " & _
                        " CLIENTS.OFI, CLIENTS.BANC, " & _
                        " CLIENTS.DC, CLIENTS.COFI, " & _
                        " clients.CTA, BANCS.DESCRIPCIO AS NOMBANC " & _
                        " FROM clients LEFT JOIN bancs ON (bancs.CODI = clients.BANC) " & _
            ...
            While dareader.Read
                With dareader
                    ...
                    strNumCuenta = general.nz(.Item("CTA"), "")
    ...
    Private Function ObtenerVencimientos(ByVal FRA1 As Double, ByVal FRA2 As Double, ByVal FECHA1 As Date, ByVal FECHA2 As Date, ByVal tenerEncuentaFechas As Boolean) As DataTable
        ...
        Dim dr As DataRow
        Try
            cmd.CommandText = "SELECT vencim.*, " & _
                    " factur.CLIENT " & _
                    " FROM vencim  " & _
                    " LEFT JOIN factur ON (factur.DOCUMENT = ""F"" AND factur.FRA = vencim.FRA AND vencim.CENTRO = factur.CENTRO)  " & _
                    " WHERE  " & _
                    " vencim.CENTRO = """ & doc(0).Item("CENTRO") & """ AND " & _
                    " vencim.COMVEN = ""V"" AND " & _
                    " vencim.FRA >= """ & FRA1 & """ AND " & _
                    " vencim.FRA <= """ & FRA2 & """  "

            If tenerEncuentaFechas Then
                cmd.CommandText = cmd.CommandText & " AND vencim.EMISSIO >= """ & ConvertirAfechaMysql(FECHA1) & """ AND " & _
    ...
    Private Function CrearTablaRecibos(ByVal FRA1 As Double, ByVal FRA2 As Double, ByVal FECHA1 As Date, ByVal FECHA2 As Date, ByVal TenerEnCuentaFechas As Boolean) As DataTable
        Dim strCliente, strBANCO, strCantidad, strBANC, strDC, strNumCta, strCOFI As String
            ...
            For i = 0 To vencimientos.Count - 1
                ...
                With vencimientos(i)
                    ...
                    If clienteActual <> clienteAnterior Then
                        obtenerDatosCliente(.Item("CLIENT"), strCliente, strBANCO, strDC, strNumCta, strCOFI, strBANC)
    ...
    Public Function ImprimirRecibos(ByVal FRA1 As Double, ByVal FRA2 As Double, ByVal FECHA1 As Date, ByVal FECHA2 As Date, ByVal TenerEnCuentaFechas As Boolean) As System.Drawing.Printing.PrintDocument
        Try
            ...
            Select Case doc(0).Item("CENTRO")
                ...
                Case "M" : c1r.Load(CurDir() & "\informes\informes.xml", "iRECIBOSCOMPLETEX")
                Case "I" : c1r.Load(CurDir() & "\informes\informes.xml", "iRECIBOSINFINIPUNT")
            End Select
