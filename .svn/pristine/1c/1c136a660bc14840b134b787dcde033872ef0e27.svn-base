...
Public Class clsTraspasosCompra
    Inherits clsADO
    Private otrasFunciones As New clsOtrasFunciones
#Region "VARIABLES"
...
#Region "TRASPASO"
    ...
    Private Sub HacerTraspasoLinea()
        ...
        Try
            If FRA = 0 Then
                FRA = otrasFunciones.CrearPAFCompra(DATA, PAF.FRA, PAF.TIPUS, PAF.DOCUMENT, PAF.dvForm, centro)
            ...
            Else
                ...
                Select Case quehacersiponenumerodestino
                    ...
                    Case 1
                        FRA = otrasFunciones.CrearPAFCompra(DATA, PAF.FRA, PAF.TIPUS, PAF.DOCUMENT, PAF.dvForm, centro, FRA)
    ...
    Friend Function TraspasarNLineas2(ByVal aAF As Integer, ByVal cantidad As Double, ByVal linea As clsLineasCompra) ' ByVal tejido As String, ByVal cantidad As Integer, ByVal color As String, ByVal documento as string, ByVal tipo as string, ByVal dvLineas As DataView, ByVal dePA As Integer, ByVal nlinea As Integer, ByVal CENTRO As Char)
        ...
        Try
            ...
            cmdInsertar.CommandText = "INSERT INTO " & tablaLineasCompras & "( " & _
                    ...
                    " " & aAF & ",  " & _
                    " " & nlineas & ", " & _
                    " """ & general.NS(linea.ARTICLE) & """,  " & _
                    " """ & general.NS(linea.DESCRI) & """,  " & _
                    " """ & general.NS(linea.COLOR) & """, " & _
                    " """ & general.NS(linea.TALLA) & """,  " & _
                    " """ & general.NS(cantidad, True) & """,  " & _
                    " """ & general.NS(linea.PREU, True) & """, " & _
                    " """ & general.NS(linea.DTE, True) & """,  " & _
                    " """ & general.NS(linea.IMPORT, True) & """, " & _
                    " " & linea.FRA & ",  " & _
                    " ""0"", " & _
                    " ""0"", " & _
                    " '', " & _
                    " """ & linea.KM & """, " & _
                    " """ & general.NS(linea.PERREBRE, True) & """, " & _
                    " """ & general.NS(linea.REBUT, True) & """, " & _
                    " """ & general.NS(linea.centro, True) & """)"
    ...
    Private Function ActualizarStockTejidos(ByVal cantidad As Double) As Boolean
        ...
        Try
            ...
            If Not cantidad < 0 Then
                ...
                Else
                    strSQL = "UPDATE " & tablaHiloColores & " SET ACTUAL = ACTUAL + " & general.NS(cantidad, True) & " WHERE(FIL = """ & general.NS(PAF.lineasCompra.ARTICLE) & """ AND TIPUS = ""T"" AND COLOR = """ & general.NS(PAF.lineasCompra.COLOR) & """)"
                End If
            ...
            Else
                If PAF.lineasCompra.COLOR = "**CRU**" AndAlso PAF.TIPUS = Tejido Then
                    SumarQuitarDispuesto("+", cantidad)
                Else
                    strSQL = "SELECT ACTUAL FROM " & tablaHiloColores & " WHERE(FIL = """ & general.NS(PAF.lineasCompra.ARTICLE) & """ AND TIPUS = ""T"" AND COLOR = """ & general.NS(PAF.lineasCompra.COLOR) & """)"
