...
Public Class frmOperacionesLista
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmOperacionesLista))
        '
        'btnTancar
        '
...
#End Region
    ...
    Shared frmChildForm As frmOperacionesLista
    Public Shared Function GetInstance(ByVal esEleccionLista As Short) As frmOperacionesLista
        If frmChildForm Is Nothing Then
            frmChildForm = New frmOperacionesLista
    ...
    Friend Overrides Sub HacerArraysCampoNombre()
        Try
            ...
            ArrayCampos = a.ObtenerArrayCamposOperaciones
    ...
    Private Sub IniciarForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            tabla = tablaTrabajos
            textoListado = rm.GetString("LOPERACIONES")
            IniciarListado()
            dv.Sort = "CODI"
    ...
    Friend Overrides Sub btnFormulario_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            Cursor = Cursors.WaitCursor
            Dim f As frmOperacionesForm = frmOperacionesForm.GetInstance()
    ...
    Friend Overrides Sub dg_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            Else
                ...
                Cursor = Cursors.Default
                cargando = True
                If f.operacionActual.centro <> dg.Item(dg.Row, "CENTRO") Then
                    f.operacionActual.centro = dg.Item(dg.Row, "CENTRO")
                    f.operacionActual.cambioCentro(GENERAL.nz(dg.Item(dg.Row, "CENTRO"), empresaPorDefecto), primero)
                    f.cboSeleccionCentro.SelectedValue = f.operacionActual.centro
                    'f.operacionActual.tabla.AcceptChanges()
                End If

                f.operacionActual.CambiarAReg(dg.Item(dg.Row, "CODI"), iraregistro)
                f.cargando = False
                cargando = False
                Me.Close()
            End If
