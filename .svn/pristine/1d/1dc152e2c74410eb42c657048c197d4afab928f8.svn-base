...
Public Class frmTransportistasLista
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmTransportistasLista))
        '
        'btnTancar
        '
        ...
        Me.Name = "frmTransportistasLista"
...
#End Region
    ...
    Shared frmChildForm As frmTransportistasLista
    Public Shared Function GetInstance(ByVal esEleccionLista As Short) As frmTransportistasLista
        If frmChildForm Is Nothing Then
            frmChildForm = New frmTransportistasLista
    ...
    Friend Overrides Sub HacerArraysCampoNombre()
        Try
            ...
            If EsEleccionOListado = esListado Then
                ArrayCampos = a.ObtenerArrayCamposTransportistas
            Else
                With ArrayCampos
                    a.aCODIGO(3) = 1
    ...
    Private Sub IniciarForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            textoListado = rm.GetString("LTRANSPORTISTAS")
            IniciarListado()
            dv.Sort = "CODI"
    ...
    Friend Overrides Sub btnFormulario_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            Cursor = Cursors.WaitCursor
            Dim f As frmTransportistasForm = frmTransportistasForm.GetInstance()
