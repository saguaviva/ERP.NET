...
Public Class frmOperacionesForm
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    Friend WithEvents lblCodigoOperacion As Label
    Friend WithEvents TabControl1 As System.Windows.Forms.TabControl
    Friend WithEvents TabPage1 As System.Windows.Forms.TabPage
    Friend WithEvents cboID As C1.Win.C1List.C1Combo

    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmOperacionesForm))
        Me.lblNombreIVA = New System.Windows.Forms.Label
        Me.lblCodigoOperacion = New System.Windows.Forms.Label
        ...
        Me.lblNombreIVA.Location = New System.Drawing.Point(16, 60)
        Me.lblNombreIVA.Name = "lblNombreIVA"
        Me.lblNombreIVA.Size = New System.Drawing.Size(80, 18)
        ...
        'lblCodigoOperacion
        '
        Me.lblCodigoOperacion.ImeMode = System.Windows.Forms.ImeMode.NoControl
        Me.lblCodigoOperacion.Location = New System.Drawing.Point(16, 32)
        Me.lblCodigoOperacion.Name = "lblCodigoOperacion"
        Me.lblCodigoOperacion.Size = New System.Drawing.Size(80, 19)
        Me.lblCodigoOperacion.TabIndex = 206
        Me.lblCodigoOperacion.Text = "Codi Operació"
        Me.lblCodigoOperacion.TextAlign = System.Drawing.ContentAlignment.MiddleLeft
        '
        'txtDescripcion
        '
        Me.txtDescripcion.Location = New System.Drawing.Point(100, 64)
        ...
        Me.TabControl1.ItemSize = New System.Drawing.Size(55, 18)
        Me.TabControl1.Location = New System.Drawing.Point(12, 8)
        Me.TabControl1.Name = "TabControl1"
        Me.TabControl1.SelectedIndex = 0
        Me.TabControl1.Size = New System.Drawing.Size(484, 144)
        ...
        Me.TabPage1.Controls.Add(Me.lblCodigoOperacion)
        Me.TabPage1.Location = New System.Drawing.Point(4, 22)
        Me.TabPage1.Name = "TabPage1"
        Me.TabPage1.Size = New System.Drawing.Size(476, 118)
        Me.TabPage1.TabIndex = 0
        Me.TabPage1.Text = "Operació"
        '
        'cboID
        '
        ...
        Me.cboID.Location = New System.Drawing.Point(100, 32)
        ...
        "}Heading{Wrap:True;AlignVert:Center;Border:Flat,ControlDark,1, 1, 1, 1;ForeColor" & _
        ":ControlText;BackColor:Control;}Style8{}Style10{}Style11{}Style1{}</Data></Style" & _
...
#End Region
    ...
    Shared frmChildForm As frmOperacionesForm
    Public Shared Function GetInstance() As frmOperacionesForm
        If frmChildForm Is Nothing Then
            frmChildForm = New frmOperacionesForm
...
#Region "VARIABLES"
    ...
    Public operacionActual As clsOperaciones
...
#Region "INICIALIZAR"
    ...
    Private Sub IniciarForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            cargando = True
            Me.arrayTextBox = New System.Windows.Forms.Control() {Me.txtDescripcion}
            operacionActual = New clsOperaciones(ds.Tables(tablaTrabajos), "C", BindingContext)
            HacerBindings()
            'operacionActual.tabla.AcceptChanges()
            PonerModificables(soloLectura)
            PSBTIPO(operacionActual.centro)
            cargando = False
    ...
    Private Sub HacerBindings()
        Try
            AñadirBinding(cboID, operacionActual.dvForm, CCTreballs)
            AñadirBinding(txtDescripcion, operacionActual.dvForm, CNTreballs)
            AñadirBindingCombo(cboID, operacionActual.dvIdentificadores, CCTreballs, CCTreballs)
...
#Region "MODIFICAR DB"
    ...
    Friend Overrides Sub btnBorrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) 'Handles btnBorrar.Click
        Try
            If MessageBox.Show(rm.GetString("BorrarOperacion"), rm.GetString("ConfirmacionEliminacion"), MessageBoxButtons.YesNo) = DialogResult.Yes Then
                editando = True
                operacionActual.borrar() : ActualizarOrigen()
                editando = False
            End If
    ...
    Private Sub ActualizarOrigen()
        Try
            ...
            If EsRegistroNuevo Then
                editando = True : PSBTIPO(operacionActual.centro)
                PonerControlesNuevo(esRegistroExistente)
    ...
    Friend Overrides Sub btnActualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) 'Handles btnActualizar.Click
        Try
            cargando = True
            If operacionActual.TieneCambios Then
                Select Case MessageBox.Show(rm.GetString("QUIERECONFIRMARLOSCAMBIOS"), rm.GetString("INFORMACION"), MessageBoxButtons.YesNoCancel)
                    ...
                    Case DialogResult.No
                        operacionActual.tabla.RejectChanges()
                        cargando = False
                        Exit Sub
                End Select
            End If
            operacionActual.ActualizarOrigen() : ActualizarOrigen()
            PSBTIPO(operacionActual.centro) : cargando = False

        Catch ex As Exception
            LOG(ex.ToString) : cargando = False : CCN()
        End Try
    End Sub
    Friend Overrides Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)  'Handles btnNuevaOperacion.Click
        Try
            cargando = True
            EsRegistroNuevo = True
            PonerModificables(modificable)
            PonerControlesNuevo(False)
            operacionActual.NuevoRegistro()
            PSBTIPO(operacionActual.centro) : cargando = False
...
#Region "COMUNES"
    ...
    Private Sub PonerModificables(Optional ByVal b As Boolean = False)
        Try
            ...
            Else : AñadirBindingCombo(cboID, operacionActual.dvIdentificadores, CCTreballs, CCTreballs) : operacionActual.tabla.AcceptChanges() : End If
    ...
    Private Sub btnVerLista_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVerLista.Click
        Try
            Cursor = Cursors.WaitCursor
            Dim f As frmOperacionesLista = frmOperacionesLista.GetInstance(esListado)
...
#Region "DESPLAZARSE"
    ...
    Protected Friend Overrides Sub btnPrimero_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)  'Handles btnPrimero.Click
        Try
            cargando = True
            operacionActual.PrimeroReg() : ActualizarOrigen()
            PSBTIPO(operacionActual.centro) : cargando = False
    ...
    Friend Overrides Sub btnUltimo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) 'Handles btnUltimo.Click
        Try
            cargando = True
            operacionActual.UltimoReg() : ActualizarOrigen()
            PSBTIPO(operacionActual.centro) : cargando = False
    ...
    Friend Overrides Sub btnAnterior_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)  'Handles btnAnterior.Click
        Try
            cargando = True
            operacionActual.AnteriorReg() : ActualizarOrigen()
            PSBTIPO(operacionActual.centro) : cargando = False
    ...
    Friend Overrides Sub btnSiguiente_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)  'Handles btnSiguiente.Click
        Try
            cargando = True
            operacionActual.SiguienteReg() : ActualizarOrigen()
            PSBTIPO(operacionActual.centro) : cargando = False
...
#Region "SELECCIÓN REGISTRO"
    ...
    Private Sub cboID_ItemChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboid.RowChange
        Try
            If consulta() Then
                cargando = True
                operacionActual.CambiarAReg(GENERAL.nz(cboID.WillChangeToValue, ""), iraregistro)
                PSBTIPO(operacionActual.centro) : cargando = False
            End If
        Catch ex As Exception
            LOG(ex.ToString) : cargando = False : CCN()
