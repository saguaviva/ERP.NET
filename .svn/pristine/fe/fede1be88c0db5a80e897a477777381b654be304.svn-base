...
Public Class frmListaOrdenesModelos
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmListaOrdenesModelos))
        '
        'cboSeleccionCentro
        '
        ...
        Me.Name = "frmListaOrdenesModelos"
...
#End Region
    ...
    Shared frmChildForm As frmListaOrdenesModelos
    Public Shared Function GetInstance(ByVal esEleccionLista As Short) As frmListaOrdenesModelos
        If frmChildForm Is Nothing Then
            frmChildForm = New frmListaOrdenesModelos
    ...
    Friend Overrides Sub HacerArraysCampoNombre()
        ...
        Try
            With ArrayCampos
                ...
                .Add("ENTRADA", a.aFECHAENTRADA)
                .Add("PREVISTA", a.aFECHAPREVISTA)
                .Add("FINAL", a.aFECHAFINAL)
                .Add("CLIENT", a.aCLIENT)
                .Add("NOMCENTRO", a.aNOMCENTRO)
            End With
    ...
    Friend Overrides Sub CrearComandos()
        Try
            If EsEleccionOListado = esEleccion Then
                cmdSelect.CommandText = "SELECT " & tabla & ".ORDRE, " & tabla & ".MODEL, " & _
                                            " " & tabla & ".TEMPORADA, " & tabla & ".SERIE, " & _
                                            " " & tabla & ".CLIENT, " & tabla & ".CENTRO, " & tabla & ".PREU, " & _
                                            " " & tabla & ".TALLA01," & tabla & ".TALLA02," & tabla & ".TALLA03," & tabla & ".TALLA04, " & _
                                            " " & tabla & ".TALLA05, " & tabla & ".TALLA06, " & tabla & ".TALLA07," & tabla & ".TALLA08," & tabla & ".TALLA09," & tabla & ".TALLA10," & _
    ...
    Private Sub IniciarForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            tabla = tablaOrdenesModelos
            textoListado = rm.GetString("LORDENESFAB")
            IniciarListado()
            dv.Sort = "ORDRE"
    ...
    Friend Overrides Sub dg_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            Else
                ...
                f.BringToFront()
                Cursor = Cursors.Default
                f.PAFActual.CambiarAReg(dg.Item(dg.Row, "ORDRE"), iraregistro)
                Me.Close()
            End If
