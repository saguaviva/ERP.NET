...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmBancosLista))
        '
        'btnTancar
        '
...
#End Region
    ...
    Shared frmChildForm As frmBancosLista
    Public Shared Function GetInstance(ByVal esEleccionLista As Short) As frmBancosLista
        If frmChildForm Is Nothing Then
            frmChildForm = New frmBancosLista
    ...
    Friend Overrides Sub CrearComandos()
        Try
            If EsEleccionOListado = esEleccion Then
                cmdSelect.CommandText = "SELECT " & tabla & ".CODI, " & tabla & ".DESCRIPCIO, " & _
    ...
    Private Sub IniciarForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            textoListado = rm.GetString("LBANCOS")
            IniciarListado()
            dv.Sort = "CODI"
    ...
    Friend Overrides Sub btnFormulario_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            Cursor = Cursors.WaitCursor
            Dim f As frmBancosForm = frmBancosForm.GetInstance()
    ...
    Friend Overrides Sub dg_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            Else
                ...
                Cursor = Cursors.Default
                cargando = True
                If f.bancoActual.centro <> dg.Item(dg.Row, "CENTRO") Then
                    f.bancoActual.centro = dg.Item(dg.Row, "CENTRO")
                    f.bancoActual.cambioCentro(GENERAL.nz(dg.Item(dg.Row, "CENTRO"), empresaPorDefecto), primero)
                    f.cboSeleccionCentro.SelectedValue = f.bancoActual.centro
                    'f.bancoActual.tabla.AcceptChanges()
                End If

                f.bancoActual.CambiarAReg(dg.Item(dg.Row, "CODI"), iraregistro)
                f.cargando = False
                cargando = False
                Me.Close()
            End If
