...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        Public WithEvents btnRecargar As C1.Win.C1Input.C1Button
        Public WithEvents btnSiguiente As C1.Win.C1Input.C1Button
        Public WithEvents btnAnterior As C1.Win.C1Input.C1Button
        Public WithEvents btnPrimero As C1.Win.C1Input.C1Button
        Public WithEvents btnUltimo As C1.Win.C1Input.C1Button
        Public WithEvents btnModificar As C1.Win.C1Input.C1Button
        Public WithEvents btnTancar As C1.Win.C1Input.C1Button
        Public WithEvents btnBorrar As C1.Win.C1Input.C1Button
        Public WithEvents btnNuevo As C1.Win.C1Input.C1Button
        Public WithEvents btnActualizar As C1.Win.C1Input.C1Button
        Public WithEvents btnVerLista As C1.Win.C1Input.C1Button
...
#Region "VARIABLES"
        ...
        Public arrayTextBox As Control()
        Public arrayEtiquetas As Control()
        Public arrayBotones As Control()
        Public arrayTabPages As Control()
        Public arrayCheckBox As Control()
        Public arrayCombos As Control()
        Public arrayDateTime As Control()
        Public arrayPictureBox As Control()
        Public arrayListas As Control()
        Public arrayGrids As Control()
        Public arrayRadios As Control()
...
#Region "INICIAR"
        ...
        Private Sub frmBase_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Try
                ...
                Me.arrayTextBox = New Control() {}
                Me.arrayEtiquetas = New System.Windows.Forms.Control() {}
                Me.arrayBotones = New System.Windows.Forms.Control() {}
                Me.arrayGrids = New System.Windows.Forms.Control() {}
                Me.arrayCheckBox = New System.Windows.Forms.Control() {}
                Me.arrayCombos = New System.Windows.Forms.Control() {}
                Me.arrayTabPages = New System.Windows.Forms.Control() {}
                Me.arrayDateTime = New Control() {}
                Me.arrayListas = New Control() {}
                Me.arrayPictureBox = New Control() {}
                Me.arrayRadios = New Control() {}
        ...
        Private Sub MaxDropCombos()
            Dim i As Integer
            Try
                If Not arrayCombos Is Nothing Then

                    For i = 0 To arrayCombos.Length - 1
                        Select Case arrayCombos(i).GetType.ToString
                            Case "C1.Win.C1List.C1Combo"
                                DirectCast(arrayCombos(i), C1.Win.C1List.C1Combo).MaxDropDownItems = 10

                            Case "System.Windows.Forms.ComboBox"
                                DirectCast(arrayCombos(i), System.Windows.Forms.ComboBox).MaxDropDownItems = 10
                        End Select
                    Next
                End If
                If Not arrayGrids Is Nothing Then

                    For i = 0 To arrayGrids.Length - 1
                        If arrayGrids(i).GetType.ToString = "C1.Win.C1TrueDBGrid.C1TrueDBGrid" Then
                            DirectCast(arrayGrids(i), C1.Win.C1TrueDBGrid.C1TrueDBGrid).TabAction = C1.Win.C1TrueDBGrid.TabActionEnum.GridNavigation
                            DirectCast(arrayGrids(i), C1.Win.C1TrueDBGrid.C1TrueDBGrid).WrapCellPointer = True
                        End If
                    Next
                End If
            Catch ex As Exception
        ...
        Friend Sub PonerHandlersErroresParaGrids()
            ...
            Try
                For i = 0 To arrayGrids.Length - 1
                    If arrayGrids(i).GetType.ToString = "C1.Win.C1TrueDBGrid.C1TrueDBGrid" Then
                        AddHandler DirectCast(arrayGrids(i), C1.Win.C1TrueDBGrid.C1TrueDBGrid).Error, AddressOf Errores_DG
                        AddHandler DirectCast(arrayGrids(i), C1.Win.C1TrueDBGrid.C1TrueDBGrid).BeforeColUpdate, AddressOf validando
                    End If
                Next
        ...
        Friend Sub AutoSizeControles()
            ...
            Try
                For i = 0 To arrayCombos.Length - 1
                    Select Case arrayCombos(i).GetType.ToString
                        Case "C1.Win.C1List.C1Combo"
                            AutosizeColumnasCombo(DirectCast(arrayCombos(i), C1.Win.C1List.C1Combo))
                        Case "System.Windows.Forms.ComboBox"
                            'DirectCast(arrayCombos(i), System.Windows.Forms.ComboBox).MaxDropDownItems = 10
                    End Select
                Next
        ...
        Friend Sub HacerBindingsTodos(ByVal dvform As DataView)
            Dim i As Integer
            Try
                For i = 0 To arrayTextBox.Length - 1
                    If dvform.Table.Columns.Contains(DirectCast(arrayTextBox(i).Name, String).Substring(3)) Then
                        'Hay que hacer un binding al textbox
                        If arrayTextBox(i).DataBindings.Count = 0 Then
                            AñadirBinding(arrayTextBox(i), dvform, arrayTextBox(i).Name.Substring(3).ToUpper, "Value")
                            If dvform.Table.Columns(arrayTextBox(i).Name.Substring(3).ToUpper).MaxLength > 0 Then DirectCast(arrayTextBox(i), Object).MaxLength = dvform.Table.Columns(arrayTextBox(i).Name.Substring(3).ToUpper).MaxLength
                            If dvform.Table.Columns(arrayTextBox(i).Name.Substring(3).ToUpper).DataType Is GetType(Integer) Then
                                'ForzarTextBoxEntero(DirectCast(arrayTextBox(i), Object))
                                If noEsID(arrayTextBox(i).Name.Substring(3).ToUpper) Then
                                    Try
                                        DirectCast(arrayTextBox(i), C1.Win.C1Input.C1TextBox).DataType = GetType(System.Int64)
                                        DirectCast(arrayTextBox(i), C1.Win.C1Input.C1TextBox).FormatType = C1.Win.C1Input.FormatTypeEnum.CustomFormat
                                        DirectCast(arrayTextBox(i), C1.Win.C1Input.C1TextBox).CustomFormat = "###,###,###,###,##0"

                                    Catch ex As Exception : LOG(ex.ToString) : End Try
                                End If
                            End If
                            If dvform.Table.Columns(arrayTextBox(i).Name.Substring(3).ToUpper).DataType Is GetType(Double) Then
                                'ForzarTextBoxDoble(DirectCast(arrayTextBox(i), Object))
                                If noEsID(arrayTextBox(i).Name.Substring(3).ToUpper) Then
                                    Try
                                        DirectCast(arrayTextBox(i), C1.Win.C1Input.C1TextBox).DataType = GetType(System.Double)
                                        DirectCast(arrayTextBox(i), C1.Win.C1Input.C1TextBox).FormatType = C1.Win.C1Input.FormatTypeEnum.CustomFormat
                                        DirectCast(arrayTextBox(i), C1.Win.C1Input.C1TextBox).CustomFormat = "###,###,###,###,##0.00"
                                    Catch ex As Exception : LOG(ex.ToString) : End Try
                                End If
                            End If
                        End If
                ...
                Next
                For i = 0 To arrayCombos.Length - 1
                    If dvform.Table.Columns.Contains(DirectCast(arrayCombos(i).Name, String).Substring(3)) Then
                        'Hay que hacer un binding al combo
                        If arrayCombos(i).DataBindings.Count = 0 Then
                            AñadirBinding(arrayCombos(i), dvform, arrayCombos(i).Name.Substring(3).ToUpper)
                            If dvform.Table.Columns(arrayCombos(i).Name.Substring(3).ToUpper).MaxLength > 0 Then DirectCast(arrayCombos(i), Object).MaxLength = dvform.Table.Columns(arrayCombos(i).Name.Substring(3).ToUpper).MaxLength
                        End If
                    End If
                Next
                For i = 0 To arrayDateTime.Length - 1
                    If dvform.Table.Columns.Contains(DirectCast(arrayDateTime(i).Name, String).Substring(3)) Then
                        If arrayDateTime(i).DataBindings.Count = 0 Then
                            AñadirBinding(arrayDateTime(i), dvform, arrayDateTime(i).Name.Substring(3).ToUpper, "Value")
                        End If
                    End If
                Next
                For i = 0 To arrayCheckBox.Length - 1
                    If dvform.Table.Columns.Contains(DirectCast(arrayCheckBox(i).Name, String).Substring(3)) Then
                        If arrayCheckBox(i).DataBindings.Count = 0 Then
                            AñadirBinding(arrayCheckBox(i), dvform, arrayCheckBox(i).Name.Substring(3).ToUpper, "Checked")
                        End If
                    End If
                Next
                For i = 0 To arrayPictureBox.Length - 1
                    If dvform.Table.Columns.Contains(DirectCast(arrayPictureBox(i).Name, String).Substring(3)) Then
                        If arrayPictureBox(i).DataBindings.Count = 0 Then
                            Dim bdPhoto As Binding = New Binding("Image", dvform, arrayPictureBox(i).Name.Substring(3).ToUpper)
                            AddHandler bdPhoto.Format, New ConvertEventHandler(AddressOf PictureFormat)
                            arrayPictureBox(i).DataBindings.Add(bdPhoto)
                        End If
                    End If
                Next
                For i = 0 To arrayRadios.Length - 1
                    If dvform.Table.Columns.Contains(DirectCast(arrayRadios(i).Name, String).Substring(3)) Then
                        If arrayRadios(i).DataBindings.Count = 0 Then
                            AñadirBinding(arrayRadios(i), dvform, arrayRadios(i).Name.Substring(3).ToUpper, "Checked")
                        End If
                    End If
                Next
...
#Region "MODIFICAR"
        ...
        Friend Sub PonerMod(ByVal b As Boolean)
            Dim i As Integer
            Try
                'arrayBotones.SetEnabled(Not b)
                For i = 0 To arrayBotones.Length - 1
                    DirectCast(arrayBotones(i), Control).Enabled = Not b
                Next
                'arrayCheckBox.SetEnabled(Not b)
                For i = 0 To arrayCheckBox.Length - 1
                    DirectCast(arrayCheckBox(i), Control).Enabled = Not b
                Next
                'arrayCombos.SetReadOnly(b)
                'arrayCombos.SetAutoCompletion(True)
                'arrayCombos.SetProperty("LimitToList", b)
                For i = 0 To arrayCombos.Length - 1
                    Select Case arrayCombos(i).GetType.ToString
                        Case "C1.Win.C1List.C1Combo"
                            DirectCast(arrayCombos(i), C1.Win.C1List.C1Combo).ReadOnly = b
                            DirectCast(arrayCombos(i), C1.Win.C1List.C1Combo).AutoCompletion = True
                            DirectCast(arrayCombos(i), C1.Win.C1List.C1Combo).LimitToList = b
                        Case "System.Windows.Forms.ComboBox"
                            MsgBox("error mod como")
                            'DirectCast(arrayCombos(i), ComboBox).ReadOnly = b
                            'DirectCast(arrayCombos(i), ComboBox).AutoCompletion = True
                            'DirectCast(arrayCombos(i), ComboBox).LimitToList = b
                    End Select

                Next


                'arrayDateTime.SetReadOnly(b)
                ''arrayDateTime.Enabled = Not b

                For i = 0 To arrayDateTime.Length - 1
                    DirectCast(arrayDateTime(i), C1.Win.C1Input.C1DateEdit).ReadOnly = b
                    DirectCast(arrayDateTime(i), C1.Win.C1Input.C1DateEdit).Enabled = Not b
                Next

                'arrayRadios.SetEnabled(Not b)
                For i = 0 To arrayRadios.Length - 1
                    DirectCast(arrayRadios(i), C1.Win.C1Input.C1DateEdit).Enabled = Not b
                Next
                For i = 0 To arrayGrids.Length - 1
                    If arrayGrids(i).GetType.ToString = "C1.Win.C1TrueDBGrid.C1TrueDBGrid" Then
                        DirectCast(arrayGrids(i), C1.Win.C1TrueDBGrid.C1TrueDBGrid).AllowUpdate = Not b
                        DirectCast(arrayGrids(i), C1.Win.C1TrueDBGrid.C1TrueDBGrid).AllowAddNew = Not b
                        DirectCast(arrayGrids(i), C1.Win.C1TrueDBGrid.C1TrueDBGrid).AllowRowSelect = Not b
                        DirectCast(arrayGrids(i), C1.Win.C1TrueDBGrid.C1TrueDBGrid).AllowDelete = Not b
                    End If
                Next
                'arrayTextBox.SetReadOnly(b)

                For i = 0 To arrayTextBox.Length - 1
                    DirectCast(arrayTextBox(i), C1.Win.C1Input.C1TextBox).ReadOnly = b
                Next

                'arrayListas.SetEnabled(Not b)
                For i = 0 To arrayListas.Length - 1
                    DirectCast(arrayListas(i), Control).Enabled = b
                Next
            Catch ex As Exception
                LOG(ex.ToString) : cargando = False : CCN()
            End Try
...
#Region "PONER CONTROLES"
        ...
        Private Sub ColocarBotonesControl()
            ...
            Dim h As Integer = Me.Size.Height - 72
            'Dim h As Integer = Me.Size.Height - 70
        ...
        Private Sub ColocarCBOCENTRO()
            Dim p As Point
            Select Case Me.Name
                Case "frmOrdenesFabricacion"
                    p.X = Me.Size.Width - cboSeleccionCentro.Size.Width - 48
                    p.Y = 15
                Case "frmTejidoVentaAlbaran", "frmVentaFactura", "frmVentaFacturaProforma", "frmVentaPedido"
                    p.X = Me.Size.Width - cboSeleccionCentro.Size.Width - 25
                    p.Y = 24
                Case Else
            ...
            cboSeleccionCentro.Size = New System.Drawing.Size(158, 21)
        ...
        Private Function TieneControles() As Boolean
            Select Case Me.Name
                ...
                Case "frmForniturasCompraPedido", "frmIVAForm", "frmOrdenesFabricacion", "frmMuestrasComprasAlbaran", "frmMuestrasComprasPedido", "frmMuestrasOrdenes"
                    Return True
                Case "frmMaquinasForm", "frmOperacionesForm", "frmTalleresForm", "frmFornituras", "frmPagoForm"
                    Return True
