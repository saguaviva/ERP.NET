...
#Region "CAMPOS"
    ...
    Public Property CODICLIENT() As String
        Get
            If PA = -1 Then Exit Property
            Try
                mCODICLIENT = general.nz(dvForm(pa).Row("CODICLIENT"), "")
            Catch ex As Exception : End Try
            Return general.nz(mCODICLIENT, "")
        End Get
        Set(ByVal Value As String)
            If PA = -1 Then Exit Property
            If general.nz(Value, "") <> general.nz(CODICLIENT, "") Then
                mCODICLIENT = general.nz(Value, "")
                dvForm(pa).Row("CODICLIENT") = general.nz(mCODICLIENT, "") : GuardarDV()
            End If
        End Set
    End Property
    ...
    Public Property ANY() As String
        Get
            If PA = -1 Then Exit Property
            Try
                mANY = general.nz(dvForm(pa).Row("ANY"), "")
            Catch ex As Exception : End Try
            Return general.nz(mANY, "")
        End Get
        Set(ByVal Value As String)
            If PA = -1 Then Exit Property
            If general.nz(Value, "") <> general.nz(ANY, "") Then
                mANY = general.nz(Value, "")
                dvForm(pa).Row("ANY") = general.nz(mANY, "") : GuardarDV()
            End If
        End Set
    End Property
        ...
        Set(ByVal Value As Integer)
            ...
            If esCodigoExistente(dtAcabadores, CCTallers, Value) Then
                If nzn(Value, 0) <> 0 Then
                    ...
                    dvForm(pa).Row("NOMACABADOR") = general.OBN(Value, dtAcabadores, CNTallers)
    ...
    Public Property COLORCLIENTE() As String
        Get
            If PA = -1 Then Exit Property
            Try
                mCOLORCLIENTE = general.nz(dvForm(pa).Row("COLORCLIENTE"), "")
            Catch ex As Exception : End Try
            Return general.nz(mCOLORCLIENTE, "")
        End Get
        Set(ByVal Value As String)
            If PA = -1 Then Exit Property
            If general.nz(Value, "") <> general.nz(COLORCLIENTE, "") Then
                mCOLORCLIENTE = general.nz(Value, "")
                dvForm(pa).Row("COLORCLIENTE") = general.nz(mCOLORCLIENTE, "") : guardarDV()
            End If
        End Set
    End Property
    ...
    Public Property COMANDA() As String
        Get
            If PA = -1 Then Exit Property
            Try
                mCOMANDA = general.nz(dvForm(pa).Row("COMANDA"), "")
            Catch ex As Exception : End Try
            Return general.nz(mCOMANDA, "")
        End Get
        Set(ByVal Value As String)
            If PA = -1 Then Exit Property
            If general.nz(Value, "") <> general.nz(COMANDA, "") Then
                mCOMANDA = general.nz(Value, "")
                dvForm(pa).Row("COMANDA") = general.nz(mCOMANDA, "") : guardarDV()
            End If
        End Set
    End Property
    ...
    Public Sub CargarTablas()
        ...
        Try
            ...
            cmdSelect.CommandText = "SELECT " & _
                ...
                " TEIXITS.TEIXIDOR, " & _
                " TEIXITS.ACABADOR " & _
                " FROM TEIXITS WHERE CENTRO = """ & Me.centro & """ "
...
#Region "OVERRIDES"
    ...
    Friend Overrides Sub PonerNombres()
        ...
        Try
            ...
            NOMACABADOR = general.OBN(ACABADOR, dtAcabadores)
...
#Region "IMPRIMIR"
    ...
    Private Function PonerCabecera(ByVal objhoja As Excel.Worksheet, ByVal hoja As Integer) As Integer
        ...
        Try
            ...
            Select Case centro
                Case "C"
                    pathLogo = CurDir() & "\imagenes\LOGO COESPUNT.tif"
                ...
                Case "O"
                    ...
                    InsertPicture(pathLogo, objhoja.Range(objhoja.Cells(1, 1), objhoja.Cells(1, 16)), objhoja.Application, False, False, False, 50, 70)
                Case "M"
                    pathLogo = CurDir() & "\imagenes\LOGOCOMPLETEXPeque.jpg"
                    InsertPicture(pathLogo, objhoja.Range(objhoja.Cells(1, 1), objhoja.Cells(1, 16)), objhoja.Application, False, False, False, 225 / 6.451, 225)
                Case "I"
                    pathLogo = CurDir() & "\imagenes\LOGOINFINIPUNTPeque.jpg"
                    InsertPicture(pathLogo, objhoja.Range(objhoja.Cells(1, 1), objhoja.Cells(1, 16)), objhoja.Application, False, False, False, 50, 70)
            End Select
        ...
        Try
            ...
            With xlsDir.objHojaExcel
                Select Case Me.centro
                    Case "M"
                        '.Range("A5:A5").Value = "C/ Eduard Toldrà, 36"
                        '.Range("A6:A6").Value = "08192 Sant Quirze del Vallès (Barcelona)"
                        '.Range("A7:A7").Value = "Telf.: (34) 93 337 08 00"
                        ...
                        .Range("A8:A8").Value = "Fax.: 93.337.35.74"
                        .Range("A9:A9").Value = "N.I.F.B-65.123.424"
                    Case "C"
                        .Range("A5:A5").Value = "C/Masia de Can Coll.7 - Pol. Ind. Can Coll"
                        .Range("A6:A6").Value = "08620 SANT VICENÇ DELS HORTS"
                        .Range("A7:A7").Value = "Telf.: 93.337.07.79"
                        .Range("A8:A8").Value = "Fax.: 93.337.35.74"
                        .Range("A9:A9").Value = "N.I.F.(B-59.352.021)"
                    Case "O"
                        .Range("A5:A5").Value = "C/Masia de Can Coll.7 - Pol. Ind. Can Coll"
                        .Range("A6:A6").Value = "08620 SANT VICENÇ DELS HORTS"
                        .Range("A7:A7").Value = "Telf.: 93.337.07.79"
