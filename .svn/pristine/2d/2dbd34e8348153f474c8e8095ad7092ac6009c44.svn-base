...
Public Class frmForniturasLista
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmForniturasLista))
        '
        'btnTancar
        '
...
#End Region
    ...
    Shared frmChildForm As frmForniturasLista
    Public Shared Function GetInstance(ByVal esEleccionLista As Short, ByVal center As Char) As frmForniturasLista
        If frmChildForm Is Nothing Then
            frmChildForm = New frmForniturasLista
    ...
    Friend Overrides Sub CrearComandos()
        Try
            If EsEleccionOListado = esEleccion Then
                cmdSelect.CommandText = "SELECT forni.CODI, forni.DESCRI " & _
                        " FROM FORNI WHERE CENTRO = """ & centro & """ ORDER BY forni.CODI"
            Else
                cmdSelect.CommandText = "SELECT forni.*, " & _
                    " prove.NOM as NOMPROVE, " & _
                    " clients.NOM as NOMCLIENT FROM forni " & _
                    " LEFT JOIN prove ON (prove.CODI = forni.PROVE) " & _
                    " LEFT JOIN clients ON (clients.CODI = forni.CLIENT) " & _
                    " WHERE CENTRO = """ & centro & """ ORDER BY forni.CODI"
            End If
    ...
    Private Sub IniciarForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            textoListado = rm.GetString("LFORNITURAS")
            IniciarListado()
            dv.Sort = "CODI"
