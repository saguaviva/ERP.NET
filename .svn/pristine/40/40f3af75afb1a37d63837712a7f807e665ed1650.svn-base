...
Public Class frmHilosComprasAlbaran
...
#End Region
    ...
    Shared frmChildForm As frmHilosComprasAlbaran
    Public Shared Function GetInstance() As frmHilosComprasAlbaran
        If frmChildForm Is Nothing Then
            frmChildForm = New frmHilosComprasAlbaran
    ...
    Private Sub IniciarForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            cargando = True
            tabla = tablaCompras
            IniciarDocumento(Muestra, Albaran)
