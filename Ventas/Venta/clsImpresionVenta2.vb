...
Public Class clsImpresionVenta2
    Inherits clsADO
...
#Region "CAMPOS"
    ...
    Public Property FRA() As Integer
        ...
        End Set
    End Property
    Private mTEXTO1 As String
    Public Property TEXTO1() As String
        Get
            If PA() = -1 Then Exit Property
            Try
                mTEXTO1 = general.nz(dvForm(PA).Row("TEXTO1"), "")
            Catch ex As Exception : End Try
            Return general.nz(mTEXTO1, "")
        End Get
        Set(ByVal Value As String)
            If PA() = -1 Then Exit Property
            If general.nz(Value, "") <> general.nz(TEXTO1, "") Then
                mTEXTO1 = general.nz(Value, "")
                dvForm(PA).Row("TEXTO1") = general.nz(mTEXTO1, "") : guardarDV()
            End If
        End Set
    End Property
    ...
    Public Property TEXTO2() As String
        Get
            If PA() = -1 Then Exit Property
            Try
                mTEXTO2 = general.nz(dvForm(PA).Row("TEXTO2"), "")
            Catch ex As Exception : End Try
            Return general.nz(mTEXTO2, "")
        End Get
        Set(ByVal Value As String)
            If PA() = -1 Then Exit Property
            If general.nz(Value, "") <> general.nz(TEXTO2, "") Then
                mTEXTO2 = general.nz(Value, "")
                dvForm(PA).Row("TEXTO2") = general.nz(mTEXTO2, "") : guardarDV()
            End If
        End Set
    End Property
    ...
    Public Property TEXTO3() As String
        Get
            If PA() = -1 Then Exit Property
            Try
                mTEXTO3 = general.nz(dvForm(PA).Row("TEXTO3"), "")
            Catch ex As Exception : End Try
            Return general.nz(mTEXTO3, "")
        End Get
        Set(ByVal Value As String)
            If PA() = -1 Then Exit Property
            If general.nz(Value, "") <> general.nz(TEXTO3, "") Then
                mTEXTO3 = general.nz(Value, "")
                dvForm(PA).Row("TEXTO3") = general.nz(mTEXTO3, "") : guardarDV()
            End If
        End Set
    End Property
...
#End Region
    ...
    Public Sub New(ByVal tabla As DataTable, _
        ...
        Try
            PAF = p
            sqlSinWhere = " SELECT * FROM facturimpresion  "
